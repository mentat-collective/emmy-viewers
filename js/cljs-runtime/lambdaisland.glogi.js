...
var G__63506 = lambdaisland.glogi.logger.cljs$core$IFn$_invoke$arity$1(name);
if((G__63506 == null)){
return null;
} else {
return lambdaisland.glogi.goog_setLevel(G__63506,lambdaisland.glogi.level(lvl));
}
});
/**
...
var seq__63509 = cljs.core.seq(lvls);
var chunk__63511 = null;
var count__63512 = (0);
var i__63513 = (0);
while(true){
if((i__63513 < count__63512)){
var vec__63521 = chunk__63511.cljs$core$IIndexed$_nth$arity$2(null,i__63513);
var logger = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63521,(0),null);
var level = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63521,(1),null);
var level_63623__$1 = ((typeof level === 'string')?cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(level):level);
lambdaisland.glogi.set_level(logger,level_63623__$1);


var G__63624 = seq__63509;
var G__63625 = chunk__63511;
var G__63626 = count__63512;
var G__63627 = (i__63513 + (1));
seq__63509 = G__63624;
chunk__63511 = G__63625;
count__63512 = G__63626;
i__63513 = G__63627;
continue;
} else {
var temp__5753__auto__ = cljs.core.seq(seq__63509);
if(temp__5753__auto__){
var seq__63509__$1 = temp__5753__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__63509__$1)){
var c__4679__auto__ = cljs.core.chunk_first(seq__63509__$1);
var G__63628 = cljs.core.chunk_rest(seq__63509__$1);
var G__63629 = c__4679__auto__;
var G__63630 = cljs.core.count(c__4679__auto__);
var G__63631 = (0);
seq__63509 = G__63628;
chunk__63511 = G__63629;
count__63512 = G__63630;
i__63513 = G__63631;
continue;
} else {
var vec__63524 = cljs.core.first(seq__63509__$1);
var logger = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63524,(0),null);
var level = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63524,(1),null);
var level_63632__$1 = ((typeof level === 'string')?cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(level):level);
lambdaisland.glogi.set_level(logger,level_63632__$1);


var G__63633 = cljs.core.next(seq__63509__$1);
var G__63634 = null;
var G__63635 = (0);
var G__63636 = (0);
seq__63509 = G__63633;
chunk__63511 = G__63634;
count__63512 = G__63635;
i__63513 = G__63636;
continue;
}
} else {
...
var temp__5753__auto___63637 = goog.debug.Console.instance;
if(cljs.core.truth_(temp__5753__auto___63637)){
var instance_63638 = temp__5753__auto___63637;
instance_63638.setCapturing(true);

var instance_63639__$1 = (new goog.debug.Console());
(goog.debug.Console.instance = instance_63639__$1);

instance_63639__$1.setCapturing();
} else {
}
...
var G__63527 = (new goog.debug.FancyWindow());
G__63527.setEnabled(true);
...
var G__63528 = (new goog.debug.DivConsole(element));
G__63528.setCapturing(true);
...
var len__4864__auto___63642 = arguments.length;
var i__4865__auto___63643 = (0);
while(true){
if((i__4865__auto___63643 < len__4864__auto___63642)){
args__4870__auto__.push((arguments[i__4865__auto___63643]));

var G__63644 = (i__4865__auto___63643 + (1));
i__4865__auto___63643 = G__63644;
continue;
} else {
}
break;
...
/** @this {Function} */
(lambdaisland.glogi.swap_handlers_BANG_.cljs$lang$applyTo = (function (seq63529){
var G__63530 = cljs.core.first(seq63529);
var seq63529__$1 = cljs.core.next(seq63529);
var G__63531 = cljs.core.first(seq63529__$1);
var seq63529__$2 = cljs.core.next(seq63529__$1);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__63530,G__63531,seq63529__$2);
}));
...
return lambdaisland.glogi.goog_addHandler(G__63568,log_record_handler);
}
} else {
return null;
}
...
var logger = lambdaisland.glogi.logger.cljs$core$IFn$_invoke$arity$1(name);
if(cljs.core.truth_(logger)){
var temp__5753__auto___63651 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(lambdaisland.glogi.logger_glogi_handlers(logger),handler_fn);
if(cljs.core.truth_(temp__5753__auto___63651)){
var handler_63652 = temp__5753__auto___63651;
lambdaisland.glogi.goog_removeHandler(logger,handler_63652);
} else {
}
