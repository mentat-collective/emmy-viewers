...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(sicmutils.polynomial.impl.empty_terms,cljs.core.sort_by.cljs$core$IFn$_invoke$arity$3(sicmutils.polynomial.impl.exponents,comparator,(function (){var iter__4652__auto__ = (function sicmutils$polynomial$impl$iter__85402(s__85403){
return (new cljs.core.LazySeq(null,(function (){
var s__85403__$1 = s__85403;
while(true){
var temp__5753__auto__ = cljs.core.seq(s__85403__$1);
if(temp__5753__auto__){
var s__85403__$2 = temp__5753__auto__;
if(cljs.core.chunked_seq_QMARK_(s__85403__$2)){
var c__4650__auto__ = cljs.core.chunk_first(s__85403__$2);
var size__4651__auto__ = cljs.core.count(c__4650__auto__);
var b__85405 = cljs.core.chunk_buffer(size__4651__auto__);
if((function (){var i__85404 = (0);
while(true){
if((i__85404 < size__4651__auto__)){
var vec__85410 = cljs.core._nth(c__4650__auto__,i__85404);
var expts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__85410,(0),null);
var terms = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__85410,(1),null);
...
cljs.core.chunk_append(b__85405,sicmutils.polynomial.impl.make_term.cljs$core$IFn$_invoke$arity$2(expts__$1,coef_sum));

var G__85548 = (i__85404 + (1));
i__85404 = G__85548;
continue;
} else {
var G__85549 = (i__85404 + (1));
i__85404 = G__85549;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__85405),sicmutils$polynomial$impl$iter__85402(cljs.core.chunk_rest(s__85403__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__85405),null);
}
} else {
var vec__85416 = cljs.core.first(s__85403__$2);
var expts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__85416,(0),null);
var terms = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__85416,(1),null);
var coef_sum = cljs.core.transduce.cljs$core$IFn$_invoke$arity$3(cljs.core.map.cljs$core$IFn$_invoke$arity$1(sicmutils.polynomial.impl.coefficient),sicmutils.generic._PLUS_,terms);
if((!(sicmutils.value.zero_QMARK_(coef_sum)))){
var expts__$1 = ((cljs.core.vector_QMARK_(expts))?sicmutils.polynomial.exponent.dense__GT_exponents(expts):((cljs.core.sorted_QMARK_(expts))?expts:((cljs.core.map_QMARK_(expts))?cljs.core.into.cljs$core$IFn$_invoke$arity$2(sicmutils.polynomial.exponent.empty,expts):sicmutils.util.illegal("Invalid inputs to sparse->terms TODO")
)));
return cljs.core.cons(sicmutils.polynomial.impl.make_term.cljs$core$IFn$_invoke$arity$2(expts__$1,coef_sum),sicmutils$polynomial$impl$iter__85402(cljs.core.rest(s__85403__$2)));
} else {
var G__85557 = cljs.core.rest(s__85403__$2);
s__85403__$1 = G__85557;
continue;
}
}
} else {
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(sicmutils.polynomial.impl.empty_terms,(function (){var iter__4652__auto__ = (function sicmutils$polynomial$impl$map_coefficients_$_iter__85427(s__85428){
return (new cljs.core.LazySeq(null,(function (){
var s__85428__$1 = s__85428;
while(true){
var temp__5753__auto__ = cljs.core.seq(s__85428__$1);
if(temp__5753__auto__){
var s__85428__$2 = temp__5753__auto__;
if(cljs.core.chunked_seq_QMARK_(s__85428__$2)){
var c__4650__auto__ = cljs.core.chunk_first(s__85428__$2);
var size__4651__auto__ = cljs.core.count(c__4650__auto__);
var b__85430 = cljs.core.chunk_buffer(size__4651__auto__);
if((function (){var i__85429 = (0);
while(true){
if((i__85429 < size__4651__auto__)){
var vec__85432 = cljs.core._nth(c__4650__auto__,i__85429);
var expts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__85432,(0),null);
var c = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__85432,(1),null);
...
cljs.core.chunk_append(b__85430,sicmutils.polynomial.impl.make_term.cljs$core$IFn$_invoke$arity$2(expts,f_c));

var G__85563 = (i__85429 + (1));
i__85429 = G__85563;
continue;
} else {
var G__85564 = (i__85429 + (1));
i__85429 = G__85564;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__85430),sicmutils$polynomial$impl$map_coefficients_$_iter__85427(cljs.core.chunk_rest(s__85428__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__85430),null);
}
} else {
var vec__85441 = cljs.core.first(s__85428__$2);
var expts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__85441,(0),null);
var c = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__85441,(1),null);
var f_c = (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(c) : f.call(null,c));
if((!(sicmutils.value.zero_QMARK_(f_c)))){
return cljs.core.cons(sicmutils.polynomial.impl.make_term.cljs$core$IFn$_invoke$arity$2(expts,f_c),sicmutils$polynomial$impl$map_coefficients_$_iter__85427(cljs.core.rest(s__85428__$2)));
} else {
var G__85571 = cljs.core.rest(s__85428__$2);
s__85428__$1 = G__85571;
continue;
}
}
} else {
 ...
 */
sicmutils.polynomial.impl.t_STAR_ts = (function sicmutils$polynomial$impl$t_STAR_ts(p__85461,v){
var vec__85462 = p__85461;
var tags = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__85462,(0),null);
var coeff = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__85462,(1),null);
...
var vec__85466 = t;
var tags1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__85466,(0),null);
var coeff1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__85466,(1),null);
var G__85582 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,sicmutils.polynomial.impl.make_term.cljs$core$IFn$_invoke$arity$2(sicmutils.polynomial.exponent.mul(tags,tags1),sicmutils.generic.mul.cljs$core$IFn$_invoke$arity$2(coeff,coeff1)));
var G__85583 = (i + (1));
acc = G__85582;
i = G__85583;
continue;
...
var vec__85495 = cljs.core.peek(v);
var vn_expts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__85495,(0),null);
var vn_coeff = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__85495,(1),null);
var good_QMARK_ = (function (p1__85485_SHARP_){
return sicmutils.polynomial.exponent.every_power_QMARK_(cljs.core.pos_QMARK_,p1__85485_SHARP_);
});
...
var vec__85501 = cljs.core.peek(remainder);
var r_exponents = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__85501,(0),null);
var r_coeff = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__85501,(1),null);
...
var G__85585 = sicmutils.polynomial.impl.add(quotient,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new_term], null));
var G__85586 = sicmutils.polynomial.impl.sub(remainder,sicmutils.polynomial.impl.t_STAR_ts(new_term,v));
quotient = G__85585;
remainder = G__85586;
continue;
} else {
