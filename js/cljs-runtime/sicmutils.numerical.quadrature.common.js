...
sicmutils.numerical.quadrature.common.close_l = (function sicmutils$numerical$quadrature$common$close_l(p__88321){
var vec__88322 = p__88321;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__88322,(0),null);
var r = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__88322,(1),null);
...
sicmutils.numerical.quadrature.common.close_r = (function sicmutils$numerical$quadrature$common$close_r(p__88337){
var vec__88338 = p__88337;
var l = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__88338,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__88338,(1),null);
...
sicmutils.numerical.quadrature.common.open_l = (function sicmutils$numerical$quadrature$common$open_l(p__88346){
var vec__88359 = p__88346;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__88359,(0),null);
var r = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__88359,(1),null);
...
sicmutils.numerical.quadrature.common.open_r = (function sicmutils$numerical$quadrature$common$open_r(p__88377){
var vec__88384 = p__88377;
var l = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__88384,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__88384,(1),null);
...
sicmutils.numerical.quadrature.common.flip = (function sicmutils$numerical$quadrature$common$flip(p__88401){
var vec__88403 = p__88401;
var l = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__88403,(0),null);
var r = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__88403,(1),null);
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(opts,k,(function (){var G__88408 = sicmutils.numerical.quadrature.common.interval(opts);
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__88408) : f.call(null,G__88408));
})());
});
/**
...
var sicmutils$numerical$quadrature$common$make_integrator_fn_$_call__4 = (function (f,a,b,p__88417){
var map__88420 = p__88417;
var map__88420__$1 = cljs.core.__destructure_map(map__88420);
var opts = map__88420__$1;
var roundoff_cutoff = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__88420__$1,new cljs.core.Keyword(null,"roundoff-cutoff","roundoff-cutoff",1739938187),sicmutils.numerical.quadrature.common._STAR_roundoff_cutoff_STAR_);
...
sicmutils$numerical$quadrature$common$make_integrator_fn_$_call = function(f,a,b,p__88417){
switch(arguments.length){
case 3:
return sicmutils$numerical$quadrature$common$make_integrator_fn_$_call__3.call(this,f,a,b);
case 4:
return sicmutils$numerical$quadrature$common$make_integrator_fn_$_call__4.call(this,f,a,b,p__88417);
}
...
var vec__88432 = ((typeof cljs.core.first(body) === 'string')?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(body),cljs.core.next(body)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,body], null));
var docstring = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__88432,(0),null);
var body__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__88432,(1),null);
...
var attr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__88435,(0),null);
var body__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__88435,(1),null);
