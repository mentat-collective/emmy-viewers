...
var vec__88580 = cljs.core.peek(stack);
var l = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__88580,(0),null);
var r = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__88580,(1),null);
var interval = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__88580,(2),null);
var remaining = cljs.core.pop(stack);
var map__88583 = integrate(l,r,interval);
var map__88583__$1 = cljs.core.__destructure_map(map__88583);
var converged_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__88583__$1,new cljs.core.Keyword(null,"converged?","converged?",1779059976));
var result = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__88583__$1,new cljs.core.Keyword(null,"result","result",1415092211));
if(cljs.core.truth_(converged_QMARK_)){
var G__88640 = remaining;
var G__88641 = sicmutils.util.aggregate._STAR_fold_STAR_.call(null,sum,result);
var G__88642 = (iteration + (1));
stack = G__88640;
sum = G__88641;
iteration = G__88642;
continue;
