...
function mergeUniforms(uniforms){const merged={};for(let u=0;u<uniforms.length;u++){const tmp=cloneUniforms(uniforms[u]);for(const p in tmp)merged[p]=tmp[p]}return merged}Object.defineProperty(exports,"__esModule",{value:!0});exports.cloneUniforms=cloneUniforms;exports.mergeUniforms=mergeUniforms;exports.cloneUniformsGroups=function(src){const dst=[];for(let u=0;u<src.length;u++)dst.push(src[u].clone());return dst};exports.UniformsUtils=void 0;exports.UniformsUtils={clone:cloneUniforms,merge:mergeUniforms}}
