...
nextjournal.clerk.static_app.doc_url = (function nextjournal$clerk$static_app$doc_url(p__95282,path){
var map__95284 = p__95282;
var map__95284__$1 = cljs.core.__destructure_map(map__95284);
var path__GT_url = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__95284__$1,new cljs.core.Keyword(null,"path->url","path->url",619884785));
var current_path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__95284__$1,new cljs.core.Keyword(null,"current-path","current-path",-113759954));
var bundle_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__95284__$1,new cljs.core.Keyword(null,"bundle?","bundle?",-35631730));
...
var url__$1 = (function (){var G__95286 = url;
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__95286),"index.html"].join('');
} else {
return G__95286;
}
})();
...
nextjournal.clerk.static_app.show = (function nextjournal$clerk$static_app$show(p__95299){
var map__95300 = p__95299;
var map__95300__$1 = cljs.core.__destructure_map(map__95300);
var view_data = map__95300__$1;
var sha = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__95300__$1,new cljs.core.Keyword("git","sha","git/sha",-950222993));
var url = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__95300__$1,new cljs.core.Keyword("git","url","git/url",276391304));
var doc = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__95300__$1,new cljs.core.Keyword(null,"doc","doc",1913296891));
var path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__95300__$1,new cljs.core.Keyword(null,"path","path",-188191168));
var url__GT_path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__95300__$1,new cljs.core.Keyword(null,"url->path","url->path",1929246367));
...
nextjournal.clerk.sci_viewer.set_state(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"doc","doc",1913296891),(function (){var G__95303 = doc;
...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(G__95303,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("nextjournal","value","nextjournal/value",-1912768947),new cljs.core.Keyword(null,"blocks","blocks",-610462153)], null),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.into,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [nextjournal.clerk.static_app.hiccup(header)], null)));
} else {
return G__95303;
}
})()], null));
...
nextjournal.clerk.static_app.index = (function nextjournal$clerk$static_app$index(p__95307){
var map__95308 = p__95307;
var map__95308__$1 = cljs.core.__destructure_map(map__95308);
var view_data = map__95308__$1;
var paths = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__95308__$1,new cljs.core.Keyword(null,"paths","paths",-1807389588));
if((typeof document !== 'undefined')){
(document.title = "Clerk");
} else {
}

var with_let95309 = reagent.ratom.with_let_values(new cljs.core.Keyword(null,"with-let95309","with-let95309",1001005458));
var temp__5757__auto___95381 = reagent.ratom._STAR_ratom_context_STAR_;
if((temp__5757__auto___95381 == null)){
} else {
var c__85371__auto___95382 = temp__5757__auto___95381;
if((with_let95309.generation === c__85371__auto___95382.ratomGeneration)){
...
(with_let95309.generation = c__85371__auto___95382.ratomGeneration);
}

var init95310 = (with_let95309.length === (0));
var _BANG_state = ((((init95310) || (cljs.core.not(with_let95309.hasOwnProperty((0))))))?(with_let95309[(0)] = reagent.core.atom.cljs$core$IFn$_invoke$arity$1(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"dark-mode?","dark-mode?",2063785096),nextjournal.ui.components.localstorage.get_item(nextjournal.clerk.sci_viewer.local_storage_dark_mode_key)], null))):(with_let95309[(0)]));
var ref_fn = ((((init95310) || (cljs.core.not(with_let95309.hasOwnProperty((1))))))?(with_let95309[(1)] = (function (p1__95306_SHARP_){
if(cljs.core.truth_(p1__95306_SHARP_)){
return nextjournal.clerk.sci_viewer.setup_dark_mode_BANG_(_BANG_state);
} else {
return null;
}
})):(with_let95309[(1)]));
var res95311 = new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.bg-gray-100.dark:bg-gray-900.flex.justify-center.overflow-y-auto.w-screen.h-screen.p-4.md:p-0","div.bg-gray-100.dark:bg-gray-900.flex.justify-center.overflow-y-auto.w-screen.h-screen.p-4.md:p-0",-28305780),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"ref","ref",1289896967),ref_fn], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.fixed.top-2.left-2.md:left-auto.md:right-2.z-10","div.fixed.top-2.left-2.md:left-auto.md:right-2.z-10",-1924941252),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [nextjournal.clerk.sci_viewer.dark_mode_toggle,_BANG_state], null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.md:my-12.w-full.md:max-w-lg","div.md:my-12.w-full.md:max-w-lg",94095376),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.bg-white.dark:bg-gray-800.shadow-lg.rounded-lg.border.dark:border-gray-800.dark:text-white","div.bg-white.dark:bg-gray-800.shadow-lg.rounded-lg.border.dark:border-gray-800.dark:text-white",775975420),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.px-4.md:px-8.py-3","div.px-4.md:px-8.py-3",-415507650),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"h1.text-xl","h1.text-xl",-128714254),"Clerk"], null)], null),cljs.core.into.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"ul","ul",-1349521403)], null),cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (path){
...
var map__95329 = cljs.core.deref(nextjournal.clerk.static_app._BANG_match);
var map__95329__$1 = cljs.core.__destructure_map(map__95329);
var match = map__95329__$1;
var data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__95329__$1,new cljs.core.Keyword(null,"data","data",-232669377));
var path_params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__95329__$1,new cljs.core.Keyword(null,"path-params","path-params",-48130597));
var map__95330 = data;
var map__95330__$1 = cljs.core.__destructure_map(map__95330);
var view = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__95330__$1,new cljs.core.Keyword(null,"view","view",1247994814));
...
nextjournal.clerk.static_app.init = (function nextjournal$clerk$static_app$init(p__95333){
var map__95334 = p__95333;
var map__95334__$1 = cljs.core.__destructure_map(map__95334);
var state = map__95334__$1;
var bundle_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__95334__$1,new cljs.core.Keyword(null,"bundle?","bundle?",-35631730));
var path__GT_doc = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__95334__$1,new cljs.core.Keyword(null,"path->doc","path->doc",-634415134));
var path__GT_url = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__95334__$1,new cljs.core.Keyword(null,"path->url","path->url",619884785));
var current_path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__95334__$1,new cljs.core.Keyword(null,"current-path","current-path",-113759954));
...
if(cljs.core.truth_(bundle_QMARK_)){
var router_95396 = reitit.frontend.router.cljs$core$IFn$_invoke$arity$1(nextjournal.clerk.static_app.get_routes(url__GT_doc));
reitit.frontend.easy.start_BANG_(router_95396,(function (p1__95331_SHARP_){
return cljs.core.reset_BANG_(nextjournal.clerk.static_app._BANG_match,p1__95331_SHARP_);
