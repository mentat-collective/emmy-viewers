...
key)){var desc=hasPropertyDescriptor?Object.getOwnPropertyDescriptor(obj,key):null;desc&&(desc.get||desc.set)?Object.defineProperty(newObj,key,desc):newObj[key]=obj[key]}newObj.default=obj;nodeInterop&&nodeInterop.set(obj,newObj);return newObj}(require("module$node_modules$three$src$math$MathUtils"));let materialId=0;class Material extends global.EventDispatcher{constructor(){super();this.isMaterial=!0;Object.defineProperty(this,"id",{value:materialId++});this.uuid=MathUtils.generateUUID();this.name=
"";this.type="Material";this.blending=_constants.NormalBlending;this.side=_constants.FrontSide;this.vertexColors=!1;this.opacity=1;this.transparent=!1;this.blendSrc=_constants.SrcAlphaFactor;this.blendDst=_constants.OneMinusSrcAlphaFactor;this.blendEquation=_constants.AddEquation;this.blendEquationAlpha=this.blendDstAlpha=this.blendSrcAlpha=null;this.depthFunc=_constants.LessEqualDepth;this.depthWrite=this.depthTest=!0;this.stencilWriteMask=255;this.stencilFunc=_constants.AlwaysStencilFunc;this.stencilRef=
0;this.stencilFuncMask=255;this.stencilZPass=this.stencilZFail=this.stencilFail=_constants.KeepStencilOp;this.stencilWrite=!1;this.clippingPlanes=null;this.clipShadows=this.clipIntersection=!1;this.shadowSide=null;this.colorWrite=!0;this.precision=null;this.polygonOffset=!1;this.polygonOffsetUnits=this.polygonOffsetFactor=0;this.premultipliedAlpha=this.alphaToCoverage=this.dithering=!1;this.toneMapped=this.visible=!0;this.userData={};this._alphaTest=this.version=0}get alphaTest(){return this._alphaTest}set alphaTest(value){0<
this._alphaTest!==0<value&&this.version++;this._alphaTest=value}onBuild(){}onBeforeRender(){}onBeforeCompile(){}customProgramCacheKey(){return this.onBeforeCompile.toString()}setValues(values){if(void 0!==values)for(const key in values){const newValue=values[key];if(void 0===newValue){console.warn("THREE.Material: '"+key+"' parameter is undefined.");continue}const currentValue=this[key];void 0===currentValue?console.warn("THREE."+this.type+": '"+key+"' is not a property of this material."):currentValue&&
currentValue.isColor?currentValue.set(newValue):currentValue&&currentValue.isVector3&&newValue&&newValue.isVector3?currentValue.copy(newValue):this[key]=newValue}}toJSON(meta){function extractFromCache(cache){const values=[];for(const key in cache){const data=cache[key];delete data.metadata;values.push(data)}return values}var isRootObject=void 0===meta||"string"===typeof meta;isRootObject&&(meta={textures:{},images:{}});const data$jscomp$0={metadata:{version:4.5,type:"Material",generator:"Material.toJSON"}};
data$jscomp$0.uuid=this.uuid;data$jscomp$0.type=this.type;""!==this.name&&(data$jscomp$0.name=this.name);this.color&&this.color.isColor&&(data$jscomp$0.color=this.color.getHex());void 0!==this.roughness&&(data$jscomp$0.roughness=this.roughness);void 0!==this.metalness&&(data$jscomp$0.metalness=this.metalness);void 0!==this.sheen&&(data$jscomp$0.sheen=this.sheen);this.sheenColor&&this.sheenColor.isColor&&(data$jscomp$0.sheenColor=this.sheenColor.getHex());void 0!==this.sheenRoughness&&(data$jscomp$0.sheenRoughness=
this.sheenRoughness);this.emissive&&this.emissive.isColor&&(data$jscomp$0.emissive=this.emissive.getHex());this.emissiveIntensity&&1!==this.emissiveIntensity&&(data$jscomp$0.emissiveIntensity=this.emissiveIntensity);this.specular&&this.specular.isColor&&(data$jscomp$0.specular=this.specular.getHex());void 0!==this.specularIntensity&&(data$jscomp$0.specularIntensity=this.specularIntensity);this.specularColor&&this.specularColor.isColor&&(data$jscomp$0.specularColor=this.specularColor.getHex());void 0!==
this.shininess&&(data$jscomp$0.shininess=this.shininess);void 0!==this.clearcoat&&(data$jscomp$0.clearcoat=this.clearcoat);void 0!==this.clearcoatRoughness&&(data$jscomp$0.clearcoatRoughness=this.clearcoatRoughness);this.clearcoatMap&&this.clearcoatMap.isTexture&&(data$jscomp$0.clearcoatMap=this.clearcoatMap.toJSON(meta).uuid);this.clearcoatRoughnessMap&&this.clearcoatRoughnessMap.isTexture&&(data$jscomp$0.clearcoatRoughnessMap=this.clearcoatRoughnessMap.toJSON(meta).uuid);this.clearcoatNormalMap&&
this.clearcoatNormalMap.isTexture&&(data$jscomp$0.clearcoatNormalMap=this.clearcoatNormalMap.toJSON(meta).uuid,data$jscomp$0.clearcoatNormalScale=this.clearcoatNormalScale.toArray());void 0!==this.iridescence&&(data$jscomp$0.iridescence=this.iridescence);void 0!==this.iridescenceIOR&&(data$jscomp$0.iridescenceIOR=this.iridescenceIOR);void 0!==this.iridescenceThicknessRange&&(data$jscomp$0.iridescenceThicknessRange=this.iridescenceThicknessRange);this.iridescenceMap&&this.iridescenceMap.isTexture&&
...
value&&this.version++}}exports.Material=Material}
