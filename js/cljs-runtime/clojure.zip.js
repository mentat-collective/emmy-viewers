...
var G__101607 = clojure.zip.node(loc);
var fexpr__101606 = new cljs.core.Keyword("zip","branch?","zip/branch?",-998880862).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
return (fexpr__101606.cljs$core$IFn$_invoke$arity$1 ? fexpr__101606.cljs$core$IFn$_invoke$arity$1(G__101607) : fexpr__101606.call(null,G__101607));
});
/**
...
var G__101609 = clojure.zip.node(loc);
var fexpr__101608 = new cljs.core.Keyword("zip","children","zip/children",-940194589).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
return (fexpr__101608.cljs$core$IFn$_invoke$arity$1 ? fexpr__101608.cljs$core$IFn$_invoke$arity$1(G__101609) : fexpr__101608.call(null,G__101609));
} else {
...
var fexpr__101610 = new cljs.core.Keyword("zip","make-node","zip/make-node",1103800591).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
return (fexpr__101610.cljs$core$IFn$_invoke$arity$2 ? fexpr__101610.cljs$core$IFn$_invoke$arity$2(node,children) : fexpr__101610.call(null,node,children));
});
/**
...
if(cljs.core.truth_(clojure.zip.branch_QMARK_(loc))){
var vec__101611 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__101611,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__101611,(1),null);
var vec__101614 = clojure.zip.children(loc);
var seq__101615 = cljs.core.seq(vec__101614);
var first__101616 = cljs.core.first(seq__101615);
var seq__101615__$1 = cljs.core.next(seq__101615);
var c = first__101616;
var cnext = seq__101615__$1;
var cs = vec__101614;
...
var vec__101624 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__101624,(0),null);
var map__101627 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__101624,(1),null);
var map__101627__$1 = cljs.core.__destructure_map(map__101627);
var path = map__101627__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__101627__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__101627__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__101627__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__101627__$1,new cljs.core.Keyword(null,"r","r",-471384190));
var changed_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__101627__$1,new cljs.core.Keyword(null,"changed?","changed?",-437828330));
...
var vec__101653 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__101653,(0),null);
var map__101656 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__101653,(1),null);
var map__101656__$1 = cljs.core.__destructure_map(map__101656);
var path = map__101656__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__101656__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var vec__101657 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__101656__$1,new cljs.core.Keyword(null,"r","r",-471384190));
var seq__101658 = cljs.core.seq(vec__101657);
var first__101659 = cljs.core.first(seq__101658);
var seq__101658__$1 = cljs.core.next(seq__101658);
var r = first__101659;
var rnext = seq__101658__$1;
var rs = vec__101657;
...
var vec__101665 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__101665,(0),null);
var map__101668 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__101665,(1),null);
var map__101668__$1 = cljs.core.__destructure_map(map__101668);
var path = map__101668__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__101668__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__101668__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if(cljs.core.truth_((function (){var and__4251__auto__ = path;
if(cljs.core.truth_(and__4251__auto__)){
return r;
} else {
...
var vec__101681 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__101681,(0),null);
var map__101684 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__101681,(1),null);
var map__101684__$1 = cljs.core.__destructure_map(map__101684);
var path = map__101684__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__101684__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__101684__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if(cljs.core.truth_((function (){var and__4251__auto__ = path;
if(cljs.core.truth_(and__4251__auto__)){
...
var vec__101686 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__101686,(0),null);
var map__101689 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__101686,(1),null);
var map__101689__$1 = cljs.core.__destructure_map(map__101689);
var path = map__101689__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__101689__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__101689__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if(cljs.core.truth_((function (){var and__4251__auto__ = path;
if(cljs.core.truth_(and__4251__auto__)){
return cljs.core.seq(l);
} else {
...
var vec__101690 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__101690,(0),null);
var map__101693 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__101690,(1),null);
var map__101693__$1 = cljs.core.__destructure_map(map__101693);
var path = map__101693__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__101693__$1,new cljs.core.Keyword(null,"l","l",1395893423));
if((path == null)){
throw "Insert at top";
} else {
...
var vec__101694 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__101694,(0),null);
var map__101697 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__101694,(1),null);
var map__101697__$1 = cljs.core.__destructure_map(map__101697);
var path = map__101697__$1;
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__101697__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
throw "Insert at top";
} else {
...
var vec__101698 = loc;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__101698,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__101698,(1),null);
...
var len__4864__auto___101771 = arguments.length;
var i__4865__auto___101772 = (0);
while(true){
if((i__4865__auto___101772 < len__4864__auto___101771)){
args__4870__auto__.push((arguments[i__4865__auto___101772]));

var G__101773 = (i__4865__auto___101772 + (1));
i__4865__auto___101772 = G__101773;
continue;
} else {
}
break;
...
/** @this {Function} */
(clojure.zip.edit.cljs$lang$applyTo = (function (seq101701){
var G__101702 = cljs.core.first(seq101701);
var seq101701__$1 = cljs.core.next(seq101701);
var G__101703 = cljs.core.first(seq101701__$1);
var seq101701__$2 = cljs.core.next(seq101701__$1);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__101702,G__101703,seq101701__$2);
}));
...
var G__101774 = clojure.zip.up(p);
p = G__101774;
continue;
}
} else {
...
var G__101775 = clojure.zip.rightmost(child);
loc__$1 = G__101775;
continue;
} else {
return loc__$1;
...
var vec__101730 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__101730,(0),null);
var map__101733 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__101730,(1),null);
var map__101733__$1 = cljs.core.__destructure_map(map__101733);
var path = map__101733__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__101733__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__101733__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__101733__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var rs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__101733__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
throw "Remove at top";
} else {
...
var G__101776 = clojure.zip.rightmost(child);
loc__$1 = G__101776;
continue;
} else {
return loc__$1;
