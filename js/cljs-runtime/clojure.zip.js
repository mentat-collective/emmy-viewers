...
var G__88002 = clojure.zip.node(loc);
var fexpr__88001 = new cljs.core.Keyword("zip","branch?","zip/branch?",-998880862).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
return (fexpr__88001.cljs$core$IFn$_invoke$arity$1 ? fexpr__88001.cljs$core$IFn$_invoke$arity$1(G__88002) : fexpr__88001.call(null,G__88002));
});
/**
...
var G__88004 = clojure.zip.node(loc);
var fexpr__88003 = new cljs.core.Keyword("zip","children","zip/children",-940194589).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
return (fexpr__88003.cljs$core$IFn$_invoke$arity$1 ? fexpr__88003.cljs$core$IFn$_invoke$arity$1(G__88004) : fexpr__88003.call(null,G__88004));
} else {
...
var fexpr__88005 = new cljs.core.Keyword("zip","make-node","zip/make-node",1103800591).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
return (fexpr__88005.cljs$core$IFn$_invoke$arity$2 ? fexpr__88005.cljs$core$IFn$_invoke$arity$2(node,children) : fexpr__88005.call(null,node,children));
});
/**
...
if(cljs.core.truth_(clojure.zip.branch_QMARK_(loc))){
var vec__88006 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__88006,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__88006,(1),null);
var vec__88009 = clojure.zip.children(loc);
var seq__88010 = cljs.core.seq(vec__88009);
var first__88011 = cljs.core.first(seq__88010);
var seq__88010__$1 = cljs.core.next(seq__88010);
var c = first__88011;
var cnext = seq__88010__$1;
var cs = vec__88009;
...
var vec__88012 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__88012,(0),null);
var map__88015 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__88012,(1),null);
var map__88015__$1 = cljs.core.__destructure_map(map__88015);
var path = map__88015__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__88015__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__88015__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__88015__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__88015__$1,new cljs.core.Keyword(null,"r","r",-471384190));
var changed_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__88015__$1,new cljs.core.Keyword(null,"changed?","changed?",-437828330));
...
var vec__88016 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__88016,(0),null);
var map__88019 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__88016,(1),null);
var map__88019__$1 = cljs.core.__destructure_map(map__88019);
var path = map__88019__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__88019__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var vec__88020 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__88019__$1,new cljs.core.Keyword(null,"r","r",-471384190));
var seq__88021 = cljs.core.seq(vec__88020);
var first__88022 = cljs.core.first(seq__88021);
var seq__88021__$1 = cljs.core.next(seq__88021);
var r = first__88022;
var rnext = seq__88021__$1;
var rs = vec__88020;
...
var vec__88023 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__88023,(0),null);
var map__88026 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__88023,(1),null);
var map__88026__$1 = cljs.core.__destructure_map(map__88026);
var path = map__88026__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__88026__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__88026__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if(cljs.core.truth_((function (){var and__4251__auto__ = path;
if(cljs.core.truth_(and__4251__auto__)){
return r;
} else {
...
var vec__88027 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__88027,(0),null);
var map__88030 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__88027,(1),null);
var map__88030__$1 = cljs.core.__destructure_map(map__88030);
var path = map__88030__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__88030__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__88030__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if(cljs.core.truth_((function (){var and__4251__auto__ = path;
if(cljs.core.truth_(and__4251__auto__)){
...
var vec__88032 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__88032,(0),null);
var map__88035 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__88032,(1),null);
var map__88035__$1 = cljs.core.__destructure_map(map__88035);
var path = map__88035__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__88035__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__88035__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if(cljs.core.truth_((function (){var and__4251__auto__ = path;
if(cljs.core.truth_(and__4251__auto__)){
return cljs.core.seq(l);
} else {
...
var vec__88038 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__88038,(0),null);
var map__88041 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__88038,(1),null);
var map__88041__$1 = cljs.core.__destructure_map(map__88041);
var path = map__88041__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__88041__$1,new cljs.core.Keyword(null,"l","l",1395893423));
if((path == null)){
throw "Insert at top";
} else {
...
var vec__88045 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__88045,(0),null);
var map__88048 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__88045,(1),null);
var map__88048__$1 = cljs.core.__destructure_map(map__88048);
var path = map__88048__$1;
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__88048__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
throw "Insert at top";
} else {
...
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__88052,(1),null);
...
var len__4864__auto___88083 = arguments.length;
var i__4865__auto___88084 = (0);
while(true){
if((i__4865__auto___88084 < len__4864__auto___88083)){
args__4870__auto__.push((arguments[i__4865__auto___88084]));

var G__88085 = (i__4865__auto___88084 + (1));
i__4865__auto___88084 = G__88085;
continue;
} else {
}
break;
...
/** @this {Function} */
(clojure.zip.edit.cljs$lang$applyTo = (function (seq88055){
var G__88056 = cljs.core.first(seq88055);
var seq88055__$1 = cljs.core.next(seq88055);
var G__88057 = cljs.core.first(seq88055__$1);
var seq88055__$2 = cljs.core.next(seq88055__$1);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__88056,G__88057,seq88055__$2);
}));
...
var G__88105 = clojure.zip.rightmost(child);
loc__$1 = G__88105;
continue;
} else {
return loc__$1;
...
var vec__88065 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__88065,(0),null);
var map__88068 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__88065,(1),null);
var map__88068__$1 = cljs.core.__destructure_map(map__88068);
var path = map__88068__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__88068__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__88068__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__88068__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var rs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__88068__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
throw "Remove at top";
} else {
...
var G__88108 = clojure.zip.rightmost(child);
loc__$1 = G__88108;
continue;
} else {
return loc__$1;
