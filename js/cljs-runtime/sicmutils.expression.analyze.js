...
var sicmutils$expression$analyze$ICanonicalize$expression__GT_$dyn_82669 = (function() {
var G__82670 = null;
var G__82670__3 = (function (analyzer,x,continue$){
...
var G__82670__4 = (function (analyzer,x,continue$,compare_fn){
var x__4550__auto__ = (((analyzer == null))?null:analyzer);
var m__4551__auto__ = (sicmutils.expression.analyze.expression__GT_[goog.typeOf(x__4550__auto__)]);
if((!((m__4551__auto__ == null)))){
...
G__82670 = function(analyzer,x,continue$,compare_fn){
switch(arguments.length){
case 3:
return G__82670__3.call(this,analyzer,x,continue$);
case 4:
return G__82670__4.call(this,analyzer,x,continue$,compare_fn);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
G__82670.cljs$core$IFn$_invoke$arity$3 = G__82670__3;
G__82670.cljs$core$IFn$_invoke$arity$4 = G__82670__4;
return G__82670;
})()
;
/**
...
return sicmutils$expression$analyze$ICanonicalize$expression__GT_$dyn_82669(analyzer,x,continue$);
}
}));
...
return sicmutils$expression$analyze$ICanonicalize$expression__GT_$dyn_82669(analyzer,x,continue$,compare_fn);
}
}));
...
var sicmutils$expression$analyze$ICanonicalize$__GT_expression$dyn_82672 = (function (analyzer,b,variables){
var x__4550__auto__ = (((analyzer == null))?null:analyzer);
...
return sicmutils$expression$analyze$ICanonicalize$__GT_expression$dyn_82672(analyzer,b,variables);
}
});

var sicmutils$expression$analyze$ICanonicalize$known_operation_QMARK_$dyn_82673 = (function (analyzer,x){
var x__4550__auto__ = (((analyzer == null))?null:analyzer);
...
return sicmutils$expression$analyze$ICanonicalize$known_operation_QMARK_$dyn_82673(analyzer,x);
}
});
...
var expr__GT_var = (function (){var G__82626 = cljs.core.PersistentArrayMap.EMPTY;
return (ref.cljs$core$IFn$_invoke$arity$1 ? ref.cljs$core$IFn$_invoke$arity$1(G__82626) : ref.call(null,G__82626));
})();
var var__GT_expr = (function (){var G__82627 = cljs.core.PersistentArrayMap.EMPTY;
return (ref.cljs$core$IFn$_invoke$arity$1 ? ref.cljs$core$IFn$_invoke$arity$1(G__82627) : ref.call(null,G__82627));
})();
...
return cljs.core.identity((function (){var temp__5751__auto__ = (function (){var fexpr__82647 = cljs.core.deref(expr__GT_var);
return (fexpr__82647.cljs$core$IFn$_invoke$arity$1 ? fexpr__82647.cljs$core$IFn$_invoke$arity$1(expr_k) : fexpr__82647.call(null,expr_k));
})();
...
var vcompare_82677 = sicmutils.expression.analyze.make_vcompare(sicmutils.expression.variables_in(expr));
cljs.core.reset_BANG_(compare_fn,vcompare_82677);

return ianalyze(expr);
});
var v_compare = (function sicmutils$expression$analyze$v_compare(v1,v2){
var fexpr__82652 = cljs.core.deref(compare_fn);
return (fexpr__82652.cljs$core$IFn$_invoke$arity$2 ? fexpr__82652.cljs$core$IFn$_invoke$arity$2(v1,v2) : fexpr__82652.call(null,v1,v2));
});
...
var temp__5751__auto__ = (function (){var fexpr__82653 = cljs.core.deref(expr__GT_var);
return (fexpr__82653.cljs$core$IFn$_invoke$arity$1 ? fexpr__82653.cljs$core$IFn$_invoke$arity$1(analyzed_expr) : fexpr__82653.call(null,analyzed_expr));
})();
if(cljs.core.truth_(temp__5751__auto__)){
var existing_expr = temp__5751__auto__;
return existing_expr;
...
var G__82654_82682 = expr__GT_var;
var G__82655_82683 = cljs.core.PersistentArrayMap.EMPTY;
(ref_set.cljs$core$IFn$_invoke$arity$2 ? ref_set.cljs$core$IFn$_invoke$arity$2(G__82654_82682,G__82655_82683) : ref_set.call(null,G__82654_82682,G__82655_82683));

var G__82656_82684 = var__GT_expr;
var G__82657_82685 = cljs.core.PersistentArrayMap.EMPTY;
(ref_set.cljs$core$IFn$_invoke$arity$2 ? ref_set.cljs$core$IFn$_invoke$arity$2(G__82656_82684,G__82657_82685) : ref_set.call(null,G__82656_82684,G__82657_82685));

return null;
});
var base_simplify = (function sicmutils$expression$analyze$base_simplify(expr){
if(cljs.core.truth_(unquoted_list_QMARK_(expr))){
return sicmutils.expression.analyze.expression__GT_(backend,expr,(function (p1__82622_SHARP_,p2__82623_SHARP_){
return sicmutils.expression.analyze.__GT_expression(backend,p1__82622_SHARP_,p2__82623_SHARP_);
}),v_compare);
} else {
return expr;
}
...
var _STAR_incremental_simplifier_STAR__orig_val__82658 = sicmutils.numsymb._STAR_incremental_simplifier_STAR_;
var _STAR_incremental_simplifier_STAR__temp_val__82659 = false;
(sicmutils.numsymb._STAR_incremental_simplifier_STAR_ = _STAR_incremental_simplifier_STAR__temp_val__82659);

try{return base_simplify(analyze(expr));
}finally {(sicmutils.numsymb._STAR_incremental_simplifier_STAR_ = _STAR_incremental_simplifier_STAR__orig_val__82658);
}});
...
var temp__5751__auto__ = (function (){var fexpr__82661 = cljs.core.deref(var__GT_expr);
return (fexpr__82661.cljs$core$IFn$_invoke$arity$1 ? fexpr__82661.cljs$core$IFn$_invoke$arity$1(expr) : fexpr__82661.call(null,expr));
})();
if(cljs.core.truth_(temp__5751__auto__)){
