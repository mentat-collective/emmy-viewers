...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_74091 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_74091(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_74095 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_74095(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_74101 = (function (reader,ch){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_74101(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_74104 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_74104(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_74105 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_74105(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_74108 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_74108(reader);
}
});
...
var G__74183 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__74184 = s.append(c);
c = G__74183;
s = G__74184;
continue;
}
