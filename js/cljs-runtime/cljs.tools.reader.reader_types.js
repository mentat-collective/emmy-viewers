...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_51303 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_51303(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_51305 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_51305(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_51308 = (function (reader,ch){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_51308(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_51310 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_51310(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_51322 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_51322(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_51333 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_51333(reader);
}
});
...
var G__51446 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__51447 = s.append(c);
c = G__51446;
s = G__51447;
continue;
}
