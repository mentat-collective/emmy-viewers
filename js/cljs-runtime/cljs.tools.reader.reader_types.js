...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_74711 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_74711(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_74713 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_74713(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_74714 = (function (reader,ch){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_74714(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_74715 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_74715(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_74717 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_74717(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_74718 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_74718(reader);
}
});
...
var G__74757 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__74758 = s.append(c);
c = G__74757;
s = G__74758;
continue;
}
