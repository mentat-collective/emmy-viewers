...
var i_54790 = (0);
while(true){
if((i_54790 < arr.length)){
(arr[i_54790] = null);

var G__54791 = (i_54790 + (1));
i_54790 = G__54791;
continue;
} else {
}
...
var i_54799 = (self__.level + (1));
while(true){
if((i_54799 <= (new_level + (1)))){
(update[i_54799] = self__.header);

var G__54800 = (i_54799 + (1));
i_54799 = G__54800;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_54802 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_54802[i]));
} else {
x__$2.forward.push((((i < links_54802.length))?(links_54802[i]):null));
}

if((i < links_54802.length)){
(links_54802[i] = x__$2);
} else {
links_54802.push(x__$2);
}
...
var i_54805 = (0);
while(true){
if((i_54805 <= self__.level)){
var links_54806 = (update[i_54805]).forward;
if((x__$1 === (((i_54805 < links_54806.length))?(links_54806[i_54805]):null))){
(links_54806[i_54805] = (x__$1.forward[i_54805]));

var G__54807 = (i_54805 + (1));
i_54805 = G__54807;
continue;
} else {
var G__54808 = (i_54805 + (1));
i_54805 = G__54808;
continue;
}
} else {
...
var G__54810 = nx;
var G__54811 = (level__$1 - (1));
x = G__54810;
level__$1 = G__54811;
continue;
} else {
var G__54812 = x;
var G__54813 = (level__$1 - (1));
x = G__54812;
level__$1 = G__54813;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__54815 = nx;
var G__54816 = (level__$1 - (1));
x = G__54815;
level__$1 = G__54816;
continue;
} else {
var G__54817 = x;
var G__54818 = (level__$1 - (1));
x = G__54817;
level__$1 = G__54818;
continue;
}
