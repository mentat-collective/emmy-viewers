...
0,STATE$jscomp$0;(function(STATE){STATE[STATE.Start=0]="Start";STATE[STATE.BasicIntegrationStep=1]="BasicIntegrationStep";STATE[STATE.ConvergenceStep=2]="ConvergenceStep";STATE[STATE.HopeForConvergence=3]="HopeForConvergence";STATE[STATE.Accept=4]="Accept";STATE[STATE.Reject=5]="Reject"})(STATE$jscomp$0||(STATE$jscomp$0={}));errx=STATE$jscomp$0.Start;a:for(;;)switch(_this.debug&&console.log("STATE",STATE$jscomp$0[errx],nStep,xOld$jscomp$0,x$jscomp$0,h$jscomp$0,k,kc,hoptde),errx){case STATE$jscomp$0.Start:var atov=
!1;if(.1*Math.abs(xEnd-x$jscomp$0)<=Math.abs(x$jscomp$0)*_this.uRound)break a;h$jscomp$0=posneg*Math.min(Math.abs(h$jscomp$0),Math.abs(xEnd-x$jscomp$0),hMax,Math.abs(hoptde));0<(x$jscomp$0+1.01*h$jscomp$0-xEnd)*posneg&&(h$jscomp$0=xEnd-x$jscomp$0,njAdd=!0);0!==nStep&&_this.denseOutput||(F(x$jscomp$0,y$jscomp$0,dz),++nEval);if(0===nStep||njAdd){iPt=0;++nStep;for(i$jscomp$0=1;i$jscomp$0<=k;++i$jscomp$0){kc=i$jscomp$0;midex(i$jscomp$0);if(atov)continue a;if(1<i$jscomp$0&&1>=err){errx=STATE$jscomp$0.Accept;
continue a}}errx=STATE$jscomp$0.HopeForConvergence;continue}errx=STATE$jscomp$0.BasicIntegrationStep;continue;case STATE$jscomp$0.BasicIntegrationStep:iPt=0;++nStep;if(nStep>=_this.maxSteps)return Outcome.MaxStepsExceeded;kc=k-1;for(i$jscomp$0=1;i$jscomp$0<=kc;++i$jscomp$0)if(midex(i$jscomp$0),atov){errx=STATE$jscomp$0.Start;continue a}errx=2===k||reject?STATE$jscomp$0.ConvergenceStep:1>=err?STATE$jscomp$0.Accept:err>Math.pow(nj[k+1]*nj[k]/4,2)?STATE$jscomp$0.Reject:STATE$jscomp$0.ConvergenceStep;
continue;case STATE$jscomp$0.ConvergenceStep:midex(k);if(atov){errx=STATE$jscomp$0.Start;continue}kc=k;if(1>=err){errx=STATE$jscomp$0.Accept;continue}errx=STATE$jscomp$0.HopeForConvergence;continue;case STATE$jscomp$0.HopeForConvergence:if(err>Math.pow(nj[k+1]/2,2)){errx=STATE$jscomp$0.Reject;continue}kc=k+1;midex(kc);errx=atov?STATE$jscomp$0.Start:1<err?STATE$jscomp$0.Reject:STATE$jscomp$0.Accept;continue;case STATE$jscomp$0.Accept:if(!acceptStep(_this.n))return Outcome.EarlyReturn;errx=STATE$jscomp$0.Start;
continue;case STATE$jscomp$0.Reject:k=Math.min(k,kc,km-1),2<k&&w[k-1]<w[k]*_this.stepSizeFac3&&--k,++nReject,h$jscomp$0=posneg*hh[k],reject=!0,errx=STATE$jscomp$0.BasicIntegrationStep}return Outcome.Converged}();return{y:y$jscomp$0.slice(1),outcome:y0,nStep,xEnd,nAccept,nReject,nEval}};return Solver}();global.dim=function(n){return Array(n+1)};global.log10=function(x){return Math.log(x)/Math.LN10};exports.Solver=global}
