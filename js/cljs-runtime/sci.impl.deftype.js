...
var hierarchy__4751__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__89520 = cljs.core.get_global_hierarchy;
return (fexpr__89520.cljs$core$IFn$_invoke$arity$0 ? fexpr__89520.cljs$core$IFn$_invoke$arity$0() : fexpr__89520.call(null));
})());
...
var sci$impl$deftype$SciPrintMethod$_sci_print_method$dyn_89571 = (function (x,w){
...
return sci$impl$deftype$SciPrintMethod$_sci_print_method$dyn_89571(x,w);
}
});
...
var len__4864__auto___89572 = arguments.length;
var i__4865__auto___89573 = (0);
while(true){
if((i__4865__auto___89573 < len__4864__auto___89572)){
args__4870__auto__.push((arguments[i__4865__auto___89573]));

var G__89574 = (i__4865__auto___89573 + (1));
i__4865__auto___89573 = G__89574;
continue;
} else {
}
break;
...
(sci.impl.deftype.deftype.cljs$core$IFn$_invoke$arity$variadic = (function (p__89545,_,ctx,record_name,fields,raw_protocol_impls){
var vec__89546 = p__89545;
var seq__89547 = cljs.core.seq(vec__89546);
var first__89548 = cljs.core.first(seq__89547);
var seq__89547__$1 = cljs.core.next(seq__89547);
var _fname = first__89548;
var ___$1 = seq__89547__$1;
var form = vec__89546;
...
var protocol_impls__$1 = cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p__89549,expr){
var vec__89550 = p__89549;
var seq__89551 = cljs.core.seq(vec__89550);
var first__89552 = cljs.core.first(seq__89551);
var seq__89551__$1 = cljs.core.next(seq__89551);
var protocol_name = first__89552;
var impls = seq__89551__$1;
var impls__$1 = cljs.core.group_by(cljs.core.first,impls);
var protocol = (function (){var G__89554 = ctx;
var G__89555 = new cljs.core.Keyword(null,"bindings","bindings",1271397192).cljs$core$IFn$_invoke$arity$1(ctx);
var G__89556 = protocol_name;
var fexpr__89553 = cljs.core.deref(sci.impl.utils.eval_resolve_state);
return (fexpr__89553.cljs$core$IFn$_invoke$arity$3 ? fexpr__89553.cljs$core$IFn$_invoke$arity$3(G__89554,G__89555,G__89556) : fexpr__89553.call(null,G__89554,G__89555,G__89556));
})();
...
var fq_meth_name = (function (p1__89537_SHARP_){
if(cljs.core.simple_symbol_QMARK_(p1__89537_SHARP_)){
return cljs.core.symbol.cljs$core$IFn$_invoke$arity$2(pns,cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__89537_SHARP_));
} else {
return p1__89537_SHARP_;
}
});
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__89557){
var vec__89559 = p__89557;
var method_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__89559,(0),null);
var bodies = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__89559,(1),null);
...
var G__89566 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(ctx,new cljs.core.Keyword(null,"deftype-fields","deftype-fields",-222569172),field_set,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"local->mutator","local->mutator",1004070878),cljs.core.zipmap(field_set,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (field){
return (function (this$,v){
return sci.impl.types._mutate(this$,field,v);
});
}),field_set))], 0));
var G__89567 = cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic((new cljs.core.List(null,new cljs.core.Symbol("cljs.core","defmethod","cljs.core/defmethod",-180785162,null),null,(1),null)),(new cljs.core.List(null,fq_meth_name(method_name),null,(1),null)),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(new cljs.core.List(null,rec_type,null,(1),null)),bodies__$2], 0))));
var fexpr__89565 = cljs.core.deref(sci.impl.utils.analyze);
return (fexpr__89565.cljs$core$IFn$_invoke$arity$2 ? fexpr__89565.cljs$core$IFn$_invoke$arity$2(G__89566,G__89567) : fexpr__89565.call(null,G__89566,G__89567));
}
}),impls__$1);
}),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([protocol_impls,raw_protocol_impls], 0));
return cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic((new cljs.core.List(null,new cljs.core.Symbol(null,"do","do",1686842252,null),null,(1),null)),(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic((new cljs.core.List(null,new cljs.core.Symbol("cljs.core","declare","cljs.core/declare",1312638100,null),null,(1),null)),(new cljs.core.List(null,record_name,null,(1),null)),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(new cljs.core.List(null,factory_fn_sym,null,(1),null))], 0)))),null,(1),null)),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic((new cljs.core.List(null,new cljs.core.Symbol(null,"def","def",597100991,null),null,(1),null)),(new cljs.core.List(null,cljs.core.with_meta(record_name,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword("sci","type","sci/type",1175422389),true], null)),null,(1),null)),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$2((new cljs.core.List(null,new cljs.core.Symbol("sci.impl.deftype","-create-type","sci.impl.deftype/-create-type",-1020101113,null),null,(1),null)),(new cljs.core.List(null,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword("sci.impl","type-name","sci.impl/type-name",-1528979388),(new cljs.core.List(null,new cljs.core.Symbol(null,"quote","quote",1377916282,null),(new cljs.core.List(null,rec_type,null,(1),null)),(2),null)),new cljs.core.Keyword("sci.impl","type","sci.impl/type",1797552241),rec_type,new cljs.core.Keyword("sci.impl","constructor","sci.impl/constructor",1320345666),(new cljs.core.List(null,new cljs.core.Symbol(null,"var","var",870848730,null),(new cljs.core.List(null,factory_fn_sym,null,(1),null)),(2),null)),new cljs.core.Keyword("sci.impl","var","sci.impl/var",-2041185552),(new cljs.core.List(null,new cljs.core.Symbol(null,"var","var",870848730,null),(new cljs.core.List(null,record_name,null,(1),null)),(2),null))], null),null,(1),null))))),null,(1),null))], 0)))),null,(1),null)),(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic((new cljs.core.List(null,new cljs.core.Symbol("cljs.core","defn","cljs.core/defn",-1606493717,null),null,(1),null)),(new cljs.core.List(null,factory_fn_sym,null,(1),null)),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(new cljs.core.List(null,cljs.core.vec(cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$2((new cljs.core.List(null,new cljs.core.Symbol(null,"&","&",-2144855648,null),null,(1),null)),(new cljs.core.List(null,new cljs.core.Symbol(null,"args__89538__auto__","args__89538__auto__",-1867545417,null),null,(1),null)))))),null,(1),null)),(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic((new cljs.core.List(null,new cljs.core.Symbol("sci.impl.deftype","->type-impl","sci.impl.deftype/->type-impl",-2121297742,null),null,(1),null)),(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$2((new cljs.core.List(null,new cljs.core.Symbol(null,"quote","quote",1377916282,null),null,(1),null)),(new cljs.core.List(null,rec_type,null,(1),null))))),null,(1),null)),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(new cljs.core.List(null,rec_type,null,(1),null)),(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$2((new cljs.core.List(null,new cljs.core.Symbol(null,"var","var",870848730,null),null,(1),null)),(new cljs.core.List(null,record_name,null,(1),null))))),null,(1),null)),(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic((new cljs.core.List(null,new cljs.core.Symbol("cljs.core","zipmap","cljs.core/zipmap",-1902130674,null),null,(1),null)),(new cljs.core.List(null,(new cljs.core.List(null,new cljs.core.Symbol(null,"quote","quote",1377916282,null),(new cljs.core.List(null,fields,null,(1),null)),(2),null)),null,(1),null)),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(new cljs.core.List(null,new cljs.core.Symbol(null,"args__89538__auto__","args__89538__auto__",-1867545417,null),null,(1),null))], 0)))),null,(1),null))], 0)))),null,(1),null))], 0)))),null,(1),null)),protocol_impls__$1,(new cljs.core.List(null,record_name,null,(1),null))], 0))));
}
}));
...
/** @this {Function} */
(sci.impl.deftype.deftype.cljs$lang$applyTo = (function (seq89539){
var G__89540 = cljs.core.first(seq89539);
var seq89539__$1 = cljs.core.next(seq89539);
var G__89541 = cljs.core.first(seq89539__$1);
var seq89539__$2 = cljs.core.next(seq89539__$1);
var G__89542 = cljs.core.first(seq89539__$2);
var seq89539__$3 = cljs.core.next(seq89539__$2);
var G__89543 = cljs.core.first(seq89539__$3);
var seq89539__$4 = cljs.core.next(seq89539__$3);
var G__89544 = cljs.core.first(seq89539__$4);
var seq89539__$5 = cljs.core.next(seq89539__$4);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__89540,G__89541,G__89542,G__89543,G__89544,seq89539__$5);
}));
