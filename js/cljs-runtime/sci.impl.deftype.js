...
var hierarchy__4751__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__89932 = cljs.core.get_global_hierarchy;
return (fexpr__89932.cljs$core$IFn$_invoke$arity$0 ? fexpr__89932.cljs$core$IFn$_invoke$arity$0() : fexpr__89932.call(null));
})());
...
var sci$impl$deftype$SciPrintMethod$_sci_print_method$dyn_89989 = (function (x,w){
...
return sci$impl$deftype$SciPrintMethod$_sci_print_method$dyn_89989(x,w);
}
});
...
var len__4864__auto___89991 = arguments.length;
var i__4865__auto___89992 = (0);
while(true){
if((i__4865__auto___89992 < len__4864__auto___89991)){
args__4870__auto__.push((arguments[i__4865__auto___89992]));

var G__89993 = (i__4865__auto___89992 + (1));
i__4865__auto___89992 = G__89993;
continue;
} else {
}
break;
...
(sci.impl.deftype.deftype.cljs$core$IFn$_invoke$arity$variadic = (function (p__89952,_,ctx,record_name,fields,raw_protocol_impls){
var vec__89953 = p__89952;
var seq__89954 = cljs.core.seq(vec__89953);
var first__89955 = cljs.core.first(seq__89954);
var seq__89954__$1 = cljs.core.next(seq__89954);
var _fname = first__89955;
var ___$1 = seq__89954__$1;
var form = vec__89953;
...
var protocol_impls__$1 = cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p__89956,expr){
var vec__89957 = p__89956;
var seq__89958 = cljs.core.seq(vec__89957);
var first__89959 = cljs.core.first(seq__89958);
var seq__89958__$1 = cljs.core.next(seq__89958);
var protocol_name = first__89959;
var impls = seq__89958__$1;
var impls__$1 = cljs.core.group_by(cljs.core.first,impls);
var protocol = (function (){var G__89961 = ctx;
var G__89962 = new cljs.core.Keyword(null,"bindings","bindings",1271397192).cljs$core$IFn$_invoke$arity$1(ctx);
var G__89963 = protocol_name;
var fexpr__89960 = cljs.core.deref(sci.impl.utils.eval_resolve_state);
return (fexpr__89960.cljs$core$IFn$_invoke$arity$3 ? fexpr__89960.cljs$core$IFn$_invoke$arity$3(G__89961,G__89962,G__89963) : fexpr__89960.call(null,G__89961,G__89962,G__89963));
})();
...
var fq_meth_name = (function (p1__89944_SHARP_){
if(cljs.core.simple_symbol_QMARK_(p1__89944_SHARP_)){
return cljs.core.symbol.cljs$core$IFn$_invoke$arity$2(pns,cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__89944_SHARP_));
} else {
return p1__89944_SHARP_;
}
});
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__89964){
var vec__89965 = p__89964;
var method_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__89965,(0),null);
var bodies = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__89965,(1),null);
...
var G__89969 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(ctx,new cljs.core.Keyword(null,"deftype-fields","deftype-fields",-222569172),field_set,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"local->mutator","local->mutator",1004070878),cljs.core.zipmap(field_set,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (field){
return (function (this$,v){
return sci.impl.types._mutate(this$,field,v);
});
}),field_set))], 0));
var G__89970 = cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic((new cljs.core.List(null,new cljs.core.Symbol("cljs.core","defmethod","cljs.core/defmethod",-180785162,null),null,(1),null)),(new cljs.core.List(null,fq_meth_name(method_name),null,(1),null)),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(new cljs.core.List(null,rec_type,null,(1),null)),bodies__$2], 0))));
var fexpr__89968 = cljs.core.deref(sci.impl.utils.analyze);
return (fexpr__89968.cljs$core$IFn$_invoke$arity$2 ? fexpr__89968.cljs$core$IFn$_invoke$arity$2(G__89969,G__89970) : fexpr__89968.call(null,G__89969,G__89970));
}
}),impls__$1);
}),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([protocol_impls,raw_protocol_impls], 0));
return cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic((new cljs.core.List(null,new cljs.core.Symbol(null,"do","do",1686842252,null),null,(1),null)),(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic((new cljs.core.List(null,new cljs.core.Symbol("cljs.core","declare","cljs.core/declare",1312638100,null),null,(1),null)),(new cljs.core.List(null,record_name,null,(1),null)),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(new cljs.core.List(null,factory_fn_sym,null,(1),null))], 0)))),null,(1),null)),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic((new cljs.core.List(null,new cljs.core.Symbol(null,"def","def",597100991,null),null,(1),null)),(new cljs.core.List(null,cljs.core.with_meta(record_name,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword("sci","type","sci/type",1175422389),true], null)),null,(1),null)),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$2((new cljs.core.List(null,new cljs.core.Symbol("sci.impl.deftype","-create-type","sci.impl.deftype/-create-type",-1020101113,null),null,(1),null)),(new cljs.core.List(null,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword("sci.impl","type-name","sci.impl/type-name",-1528979388),(new cljs.core.List(null,new cljs.core.Symbol(null,"quote","quote",1377916282,null),(new cljs.core.List(null,rec_type,null,(1),null)),(2),null)),new cljs.core.Keyword("sci.impl","type","sci.impl/type",1797552241),rec_type,new cljs.core.Keyword("sci.impl","constructor","sci.impl/constructor",1320345666),(new cljs.core.List(null,new cljs.core.Symbol(null,"var","var",870848730,null),(new cljs.core.List(null,factory_fn_sym,null,(1),null)),(2),null)),new cljs.core.Keyword("sci.impl","var","sci.impl/var",-2041185552),(new cljs.core.List(null,new cljs.core.Symbol(null,"var","var",870848730,null),(new cljs.core.List(null,record_name,null,(1),null)),(2),null))], null),null,(1),null))))),null,(1),null))], 0)))),null,(1),null)),(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic((new cljs.core.List(null,new cljs.core.Symbol("cljs.core","defn","cljs.core/defn",-1606493717,null),null,(1),null)),(new cljs.core.List(null,factory_fn_sym,null,(1),null)),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(new cljs.core.List(null,cljs.core.vec(cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$2((new cljs.core.List(null,new cljs.core.Symbol(null,"&","&",-2144855648,null),null,(1),null)),(new cljs.core.List(null,new cljs.core.Symbol(null,"args__89945__auto__","args__89945__auto__",-368871967,null),null,(1),null)))))),null,(1),null)),(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic((new cljs.core.List(null,new cljs.core.Symbol("sci.impl.deftype","->type-impl","sci.impl.deftype/->type-impl",-2121297742,null),null,(1),null)),(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$2((new cljs.core.List(null,new cljs.core.Symbol(null,"quote","quote",1377916282,null),null,(1),null)),(new cljs.core.List(null,rec_type,null,(1),null))))),null,(1),null)),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(new cljs.core.List(null,rec_type,null,(1),null)),(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$2((new cljs.core.List(null,new cljs.core.Symbol(null,"var","var",870848730,null),null,(1),null)),(new cljs.core.List(null,record_name,null,(1),null))))),null,(1),null)),(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic((new cljs.core.List(null,new cljs.core.Symbol("cljs.core","zipmap","cljs.core/zipmap",-1902130674,null),null,(1),null)),(new cljs.core.List(null,(new cljs.core.List(null,new cljs.core.Symbol(null,"quote","quote",1377916282,null),(new cljs.core.List(null,fields,null,(1),null)),(2),null)),null,(1),null)),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(new cljs.core.List(null,new cljs.core.Symbol(null,"args__89945__auto__","args__89945__auto__",-368871967,null),null,(1),null))], 0)))),null,(1),null))], 0)))),null,(1),null))], 0)))),null,(1),null)),protocol_impls__$1,(new cljs.core.List(null,record_name,null,(1),null))], 0))));
}
}));
...
/** @this {Function} */
(sci.impl.deftype.deftype.cljs$lang$applyTo = (function (seq89946){
var G__89947 = cljs.core.first(seq89946);
var seq89946__$1 = cljs.core.next(seq89946);
var G__89948 = cljs.core.first(seq89946__$1);
var seq89946__$2 = cljs.core.next(seq89946__$1);
var G__89949 = cljs.core.first(seq89946__$2);
var seq89946__$3 = cljs.core.next(seq89946__$2);
var G__89950 = cljs.core.first(seq89946__$3);
var seq89946__$4 = cljs.core.next(seq89946__$3);
var G__89951 = cljs.core.first(seq89946__$4);
var seq89946__$5 = cljs.core.next(seq89946__$4);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__89947,G__89948,G__89949,G__89950,G__89951,seq89946__$5);
}));
