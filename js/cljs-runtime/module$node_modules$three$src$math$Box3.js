...
void 0;var _Vector=require("module$node_modules$three$src$math$Vector3");class Box3{constructor(min=new _Vector.Vector3(Infinity,Infinity,Infinity),max=new _Vector.Vector3(-Infinity,-Infinity,-Infinity)){this.isBox3=!0;this.min=min;this.max=max}set(min,max){this.min.copy(min);this.max.copy(max);return this}setFromArray(array){let minX=Infinity,minY=Infinity,minZ=Infinity,maxX=-Infinity,maxY=-Infinity,maxZ=-Infinity;for(let i=0,l=array.length;i<l;i+=3){const x=array[i],y=array[i+1],z=array[i+2];x<
minX&&(minX=x);y<minY&&(minY=y);z<minZ&&(minZ=z);x>maxX&&(maxX=x);y>maxY&&(maxY=y);z>maxZ&&(maxZ=z)}this.min.set(minX,minY,minZ);this.max.set(maxX,maxY,maxZ);return this}setFromBufferAttribute(attribute){let minX=Infinity,minY=Infinity,minZ=Infinity,maxX=-Infinity,maxY=-Infinity,maxZ=-Infinity;for(let i=0,l=attribute.count;i<l;i++){const x=attribute.getX(i),y=attribute.getY(i),z=attribute.getZ(i);x<minX&&(minX=x);y<minY&&(minY=y);z<minZ&&(minZ=z);x>maxX&&(maxX=x);y>maxY&&(maxY=y);z>maxZ&&(maxZ=z)}this.min.set(minX,
...
exports.Box3=Box3;const _points=[new _Vector.Vector3,new _Vector.Vector3,new _Vector.Vector3,new _Vector.Vector3,new _Vector.Vector3,new _Vector.Vector3,new _Vector.Vector3,new _Vector.Vector3],_vector=new _Vector.Vector3,_box=new Box3,_v0=new _Vector.Vector3,_v1=new _Vector.Vector3,_v2=new _Vector.Vector3,_f0=new _Vector.Vector3,_f1=new _Vector.Vector3,_f2=new _Vector.Vector3,_center=new _Vector.Vector3,_extents=new _Vector.Vector3,_triangleNormal=new _Vector.Vector3,_testAxis=new _Vector.Vector3}
