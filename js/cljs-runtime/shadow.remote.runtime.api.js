...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_79474 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_79474(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_79478 = (function (runtime,key,spec){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_79478(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_79480 = (function (runtime,key){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_79480(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_79482 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_79482(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_79483 = (function (runtime,input,callback){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_79483(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_79485 = (function (runtime,code){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_79485(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__79467,callback){
var map__79468 = p__79467;
var map__79468__$1 = cljs.core.__destructure_map(map__79468);
var input = map__79468__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__79468__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__79468__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
