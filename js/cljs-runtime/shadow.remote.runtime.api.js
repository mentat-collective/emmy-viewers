...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_78919 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_78919(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_78921 = (function (runtime,key,spec){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_78921(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_78926 = (function (runtime,key){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_78926(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_78928 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_78928(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_78932 = (function (runtime,input,callback){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_78932(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_78934 = (function (runtime,code){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_78934(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__78903,callback){
var map__78908 = p__78903;
var map__78908__$1 = cljs.core.__destructure_map(map__78908);
var input = map__78908__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78908__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78908__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
