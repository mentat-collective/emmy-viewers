...
var G__86556 = o;
reagent.impl.template.goog$module$goog$object.set(G__86556,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__86607__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__86607 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__86608__i = 0, G__86608__a = new Array(arguments.length -  0);
while (G__86608__i < G__86608__a.length) {G__86608__a[G__86608__i] = arguments[G__86608__i + 0]; ++G__86608__i;}
  args = new cljs.core.IndexedSeq(G__86608__a,0,null);
} 
return G__86607__delegate.call(this,args);};
G__86607.cljs$lang$maxFixedArity = 0;
G__86607.cljs$lang$applyTo = (function (arglist__86609){
var args = cljs.core.seq(arglist__86609);
return G__86607__delegate(args);
});
G__86607.cljs$core$IFn$_invoke$arity$variadic = G__86607__delegate;
return G__86607;
})()
;
} else {
...
var G__86562 = o;
reagent.impl.template.goog$module$goog$object.set(G__86562,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__86610__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__86610 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__86611__i = 0, G__86611__a = new Array(arguments.length -  0);
while (G__86611__i < G__86611__a.length) {G__86611__a[G__86611__i] = arguments[G__86611__i + 0]; ++G__86611__i;}
  args = new cljs.core.IndexedSeq(G__86611__a,0,null);
} 
return G__86610__delegate.call(this,args);};
G__86610.cljs$lang$maxFixedArity = 0;
G__86610.cljs$lang$applyTo = (function (arglist__86612){
var args = cljs.core.seq(arglist__86612);
return G__86610__delegate(args);
});
G__86610.cljs$core$IFn$_invoke$arity$variadic = G__86610__delegate;
return G__86610;
})()
;
} else {
...
var G__86566 = props;
var G__86566__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__86566,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__86566);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__86566__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4253__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__86568 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__86568,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__86568;
}
})(),id_class);
...
var G__86571 = (cljs.core.count(argv) - first_child);
switch (G__86571) {
case (0):
...
var vec__86574 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__86574,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__86574,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__86574,(2),null);
...
var temp__5757__auto___86615 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___86615 == null)){
} else {
var key_86616 = temp__5757__auto___86615;
(jsprops.key = key_86616);
}
...
var temp__5757__auto___86617 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___86617 == null)){
} else {
var key_86618 = temp__5757__auto___86617;
(jsprops.key = key_86618);
}
...
var temp__5757__auto___86622 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5757__auto___86622 == null)){
} else {
var key_86623 = temp__5757__auto___86622;
(jsprops.key = key_86623);
}
...
var temp__5757__auto___86629 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___86629 == null)){
} else {
var key_86630 = temp__5757__auto___86629;
(jsprops.key = key_86630);
}
...
var temp__5757__auto___86631 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___86631 == null)){
} else {
var key_86632 = temp__5757__auto___86631;
(jsprops.key = key_86632);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__86586_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__86586_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__86589 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__86589,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__86589,(1),null);
...
var G__86598 = tag;
var G__86598__$1 = (((G__86598 instanceof cljs.core.Keyword))?G__86598.fqn:null);
switch (G__86598__$1) {
case ">":
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template86602 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template86602 = (function (opts,id,fn_to_element,parse_fn,meta86603){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template86602.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_86604,meta86603__$1){
var self__ = this;
var _86604__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template86602(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta86603__$1));
}));

(reagent.impl.template.t_reagent$impl$template86602.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_86604){
var self__ = this;
var _86604__$1 = this;
return self__.meta86603;
}));

(reagent.impl.template.t_reagent$impl$template86602.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template86602.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template86602.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template86602.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template86602.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template86602.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta86603","meta86603",-1165647827,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template86602.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template86602.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template86602");

(reagent.impl.template.t_reagent$impl$template86602.cljs$lang$ctorPrWriter = (function (this__4491__auto__,writer__4492__auto__,opt__4493__auto__){
return cljs.core._write(writer__4492__auto__,"reagent.impl.template/t_reagent$impl$template86602");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template86602.
 */
reagent.impl.template.__GT_t_reagent$impl$template86602 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template86602(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta86603){
return (new reagent.impl.template.t_reagent$impl$template86602(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta86603));
});

}

return (new reagent.impl.template.t_reagent$impl$template86602(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
