...
var G__63745 = o;
reagent.impl.template.goog$module$goog$object.set(G__63745,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__63796__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__63796 = function (var_args){
var args = null;
...
while (G__63797__i < G__63797__a.length) {G__63797__a[G__63797__i] = arguments[G__63797__i + 0]; ++G__63797__i;}
  args = new cljs.core.IndexedSeq(G__63797__a,0,null);
} 
return G__63796__delegate.call(this,args);};
G__63796.cljs$lang$maxFixedArity = 0;
G__63796.cljs$lang$applyTo = (function (arglist__63798){
var args = cljs.core.seq(arglist__63798);
return G__63796__delegate(args);
});
G__63796.cljs$core$IFn$_invoke$arity$variadic = G__63796__delegate;
return G__63796;
})()
;
} else {
...
var G__63747 = o;
reagent.impl.template.goog$module$goog$object.set(G__63747,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__63801__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__63802__i < G__63802__a.length) {G__63802__a[G__63802__i] = arguments[G__63802__i + 0]; ++G__63802__i;}
  args = new cljs.core.IndexedSeq(G__63802__a,0,null);
} 
return G__63801__delegate.call(this,args);};
G__63801.cljs$lang$maxFixedArity = 0;
G__63801.cljs$lang$applyTo = (function (arglist__63803){
var args = cljs.core.seq(arglist__63803);
return G__63801__delegate(args);
});
...
var G__63752 = props;
var G__63752__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__63752,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__63752);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__63752__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4253__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__63753 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__63753,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__63753;
}
})(),id_class);
...
var G__63754 = (cljs.core.count(argv) - first_child);
switch (G__63754) {
case (0):
...
var vec__63756 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63756,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63756,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63756,(2),null);
...
var temp__5757__auto___63807 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___63807 == null)){
} else {
var key_63808 = temp__5757__auto___63807;
(jsprops.key = key_63808);
}
...
var temp__5757__auto___63809 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___63809 == null)){
} else {
var key_63810 = temp__5757__auto___63809;
(jsprops.key = key_63810);
}
...
var temp__5757__auto___63811 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5757__auto___63811 == null)){
} else {
var key_63813 = temp__5757__auto___63811;
(jsprops.key = key_63813);
}
...
var temp__5757__auto___63816 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___63816 == null)){
} else {
var key_63818 = temp__5757__auto___63816;
(jsprops.key = key_63818);
}
...
var temp__5757__auto___63819 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___63819 == null)){
} else {
var key_63820 = temp__5757__auto___63819;
(jsprops.key = key_63820);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__63772_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__63772_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__63777 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63777,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63777,(1),null);
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template63790 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template63790 = (function (opts,id,fn_to_element,parse_fn,meta63791){
this.opts = opts;
this.id = id;
this.fn_to_element = fn_to_element;
this.parse_fn = parse_fn;
this.meta63791 = meta63791;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(reagent.impl.template.t_reagent$impl$template63790.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_63792,meta63791__$1){
var self__ = this;
var _63792__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template63790(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta63791__$1));
}));

(reagent.impl.template.t_reagent$impl$template63790.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_63792){
var self__ = this;
var _63792__$1 = this;
return self__.meta63791;
}));

(reagent.impl.template.t_reagent$impl$template63790.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template63790.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template63790.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template63790.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template63790.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template63790.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta63791","meta63791",-2013330286,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template63790.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template63790.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template63790");

(reagent.impl.template.t_reagent$impl$template63790.cljs$lang$ctorPrWriter = (function (this__4491__auto__,writer__4492__auto__,opt__4493__auto__){
return cljs.core._write(writer__4492__auto__,"reagent.impl.template/t_reagent$impl$template63790");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template63790.
 */
reagent.impl.template.__GT_t_reagent$impl$template63790 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template63790(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta63791){
return (new reagent.impl.template.t_reagent$impl$template63790(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta63791));
});

}

return (new reagent.impl.template.t_reagent$impl$template63790(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
