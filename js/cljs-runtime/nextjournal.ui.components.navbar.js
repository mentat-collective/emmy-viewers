...
var map__76657 = cljs.core.deref(_BANG_state);
var map__76657__$1 = cljs.core.__destructure_map(map__76657);
var mobile_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__76657__$1,new cljs.core.Keyword(null,"mobile?","mobile?",1358664528));
var scroll_animation = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__76657__$1,new cljs.core.Keyword(null,"scroll-animation","scroll-animation",2033576100));
var scroll_el = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__76657__$1,new cljs.core.Keyword(null,"scroll-el","scroll-el",2005954473));
var visible_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__76657__$1,new cljs.core.Keyword(null,"visible?","visible?",2129863715));
...
var len__4864__auto___77109 = arguments.length;
var i__4865__auto___77110 = (0);
while(true){
if((i__4865__auto___77110 < len__4864__auto___77109)){
args__4870__auto__.push((arguments[i__4865__auto___77110]));

var G__77111 = (i__4865__auto___77110 + (1));
i__4865__auto___77110 = G__77111;
continue;
} else {
}
break;
...
(nextjournal.ui.components.navbar.toc_items.cljs$core$IFn$_invoke$arity$variadic = (function (_BANG_state,items,p__76665){
var vec__76666 = p__76665;
var options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__76666,(0),null);
var map__76669 = cljs.core.deref(_BANG_state);
var map__76669__$1 = cljs.core.__destructure_map(map__76669);
var theme = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__76669__$1,new cljs.core.Keyword(null,"theme","theme",-1247880880));
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632)], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__76674){
var map__76675 = p__76674;
var map__76675__$1 = cljs.core.__destructure_map(map__76675);
var path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__76675__$1,new cljs.core.Keyword(null,"path","path",-188191168));
var title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__76675__$1,new cljs.core.Keyword(null,"title","title",636505583));
var items__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__76675__$1,new cljs.core.Keyword(null,"items","items",1031954938));
...
/** @this {Function} */
(nextjournal.ui.components.navbar.toc_items.cljs$lang$applyTo = (function (seq76662){
var G__76663 = cljs.core.first(seq76662);
var seq76662__$1 = cljs.core.next(seq76662);
var G__76664 = cljs.core.first(seq76662__$1);
var seq76662__$2 = cljs.core.next(seq76662__$1);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__76663,G__76664,seq76662__$2);
}));
...
var map__76683 = cljs.core.deref(_BANG_state);
var map__76683__$1 = cljs.core.__destructure_map(map__76683);
var mobile_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__76683__$1,new cljs.core.Keyword(null,"mobile?","mobile?",1358664528));
var theme = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__76683__$1,new cljs.core.Keyword(null,"theme","theme",-1247880880));
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632)], null),cljs.core.map_indexed.cljs$core$IFn$_invoke$arity$2((function (i,p__76684){
var map__76685 = p__76684;
var map__76685__$1 = cljs.core.__destructure_map(map__76685);
var path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__76685__$1,new cljs.core.Keyword(null,"path","path",-188191168));
var title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__76685__$1,new cljs.core.Keyword(null,"title","title",636505583));
var expanded_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__76685__$1,new cljs.core.Keyword(null,"expanded?","expanded?",2055832296));
var loading_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__76685__$1,new cljs.core.Keyword(null,"loading?","loading?",1905707049));
var items__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__76685__$1,new cljs.core.Keyword(null,"items","items",1031954938));
var toc = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__76685__$1,new cljs.core.Keyword(null,"toc","toc",2050089251));
...
setTimeout((function (){
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(_BANG_state,(function (p1__76680_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.assoc_in(p1__76680_SHARP_,cljs.core.vec(cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(update_at,i,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"loading?","loading?",1905707049)], 0))),false),new cljs.core.Keyword(null,"toc","toc",2050089251),toc);
}));
}),(500));
} else {
}
...
var map__76717 = cljs.core.deref(_BANG_state);
var map__76717__$1 = cljs.core.__destructure_map(map__76717);
var items = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__76717__$1,new cljs.core.Keyword(null,"items","items",1031954938));
var theme = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__76717__$1,new cljs.core.Keyword(null,"theme","theme",-1247880880));
var toc = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__76717__$1,new cljs.core.Keyword(null,"toc","toc",2050089251));
...
var args__4870__auto__ = [];
var len__4864__auto___77170 = arguments.length;
var i__4865__auto___77171 = (0);
while(true){
if((i__4865__auto___77171 < len__4864__auto___77170)){
args__4870__auto__.push((arguments[i__4865__auto___77171]));

var G__77172 = (i__4865__auto___77171 + (1));
i__4865__auto___77171 = G__77172;
continue;
} else {
}
break;
...
(nextjournal.ui.components.navbar.toggle_button.cljs$core$IFn$_invoke$arity$variadic = (function (_BANG_state,content,p__76745){
var vec__76747 = p__76745;
var opts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__76747,(0),null);
var map__76754 = cljs.core.deref(_BANG_state);
var map__76754__$1 = cljs.core.__destructure_map(map__76754);
var mobile_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__76754__$1,new cljs.core.Keyword(null,"mobile?","mobile?",1358664528));
var mobile_open_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__76754__$1,new cljs.core.Keyword(null,"mobile-open?","mobile-open?",192715821));
var open_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__76754__$1,new cljs.core.Keyword(null,"open?","open?",1238443125));
...
/** @this {Function} */
(nextjournal.ui.components.navbar.toggle_button.cljs$lang$applyTo = (function (seq76734){
var G__76736 = cljs.core.first(seq76734);
var seq76734__$1 = cljs.core.next(seq76734);
var G__76737 = cljs.core.first(seq76734__$1);
var seq76734__$2 = cljs.core.next(seq76734__$1);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__76736,G__76737,seq76734__$2);
}));

nextjournal.ui.components.navbar.panel = (function nextjournal$ui$components$navbar$panel(_BANG_state,content){
var with_let76792 = reagent.ratom.with_let_values(new cljs.core.Keyword(null,"with-let76792","with-let76792",1343387439));
var temp__5757__auto___77186 = reagent.ratom._STAR_ratom_context_STAR_;
if((temp__5757__auto___77186 == null)){
} else {
var c__75051__auto___77188 = temp__5757__auto___77186;
if((with_let76792.generation === c__75051__auto___77188.ratomGeneration)){
...
(with_let76792.generation = c__75051__auto___77188.ratomGeneration);
}

var init76793 = (with_let76792.length === (0));
var map__76816 = ((((init76793) || (cljs.core.not(with_let76792.hasOwnProperty((0))))))?(with_let76792[(0)] = cljs.core.deref(_BANG_state)):(with_let76792[(0)]));
var map__76816__$1 = cljs.core.__destructure_map(map__76816);
var local_storage_key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__76816__$1,new cljs.core.Keyword(null,"local-storage-key","local-storage-key",-1983909558));
var component_key = ((((init76793) || (cljs.core.not(with_let76792.hasOwnProperty((1))))))?(with_let76792[(1)] = (function (){var or__4253__auto__ = local_storage_key;
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
} else {
...
var resize = ((((init76793) || (cljs.core.not(with_let76792.hasOwnProperty((2))))))?(with_let76792[(2)] = (function (){
...
var ref_fn = ((((init76793) || (cljs.core.not(with_let76792.hasOwnProperty((3))))))?(with_let76792[(3)] = (function (p1__76786_SHARP_){
if(cljs.core.truth_(p1__76786_SHARP_)){
if(cljs.core.truth_(local_storage_key)){
cljs.core.add_watch(_BANG_state,new cljs.core.Keyword("nextjournal.ui.components.navbar","persist","nextjournal.ui.components.navbar/persist",311826868),(function (_,___$1,old,p__76822){
var map__76825 = p__76822;
var map__76825__$1 = cljs.core.__destructure_map(map__76825);
var open_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__76825__$1,new cljs.core.Keyword(null,"open?","open?",1238443125));
...
var spring = ((((init76793) || (cljs.core.not(with_let76792.hasOwnProperty((4))))))?(with_let76792[(4)] = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"spring","spring",787848305),new cljs.core.Keyword(null,"duration","duration",1444101068),0.35,new cljs.core.Keyword(null,"bounce","bounce",1491727280),0.1], null)):(with_let76792[(4)]));
var res76795 = (function (){var map__76841 = cljs.core.deref(_BANG_state);
var map__76841__$1 = cljs.core.__destructure_map(map__76841);
var animating_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__76841__$1,new cljs.core.Keyword(null,"animating?","animating?",-333605094));
var hide_toggle_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__76841__$1,new cljs.core.Keyword(null,"hide-toggle?","hide-toggle?",-1874012773));
var animation_mode = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__76841__$1,new cljs.core.Keyword(null,"animation-mode","animation-mode",245298782));
var width = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__76841__$1,new cljs.core.Keyword(null,"width","width",-384071477));
var mobile_open_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__76841__$1,new cljs.core.Keyword(null,"mobile-open?","mobile-open?",192715821));
var mobile_width = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__76841__$1,new cljs.core.Keyword(null,"mobile-width","mobile-width",-48320880));
var mobile_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__76841__$1,new cljs.core.Keyword(null,"mobile?","mobile?",1358664528));
var theme = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__76841__$1,new cljs.core.Keyword(null,"theme","theme",-1247880880));
var open_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__76841__$1,new cljs.core.Keyword(null,"open?","open?",1238443125));
...
var with_let76870 = reagent.ratom.with_let_values(new cljs.core.Keyword(null,"with-let76870","with-let76870",-689183061));
var temp__5757__auto___77202 = reagent.ratom._STAR_ratom_context_STAR_;
if((temp__5757__auto___77202 == null)){
} else {
var c__75051__auto___77203 = temp__5757__auto___77202;
if((with_let76870.generation === c__75051__auto___77203.ratomGeneration)){
if(reagent.debug.has_console){
((reagent.debug.tracking)?reagent.debug.track_console:console).error(["Warning: The same with-let is being used more ","than once in the same reactive context."].join(''));
} else {
}
