...
var G__63981 = devtools.prefs.pref(v);
v = G__63981;
continue;
} else {
return v;
...
}catch (e63939){var _e__62393__auto__ = e63939;
return false;
}})();
...
}catch (e63941){var _e__62393__auto__ = e63941;
return false;
}})();
...
}catch (e63945){var _e__62393__auto__ = e63945;
return false;
}}
}
});
...
var vec__63957 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63957,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63957,(1),null);
...
return cljs.core.some((function (p1__63966_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__63966_SHARP_);
}),template);
});
