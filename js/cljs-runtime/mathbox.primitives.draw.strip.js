goog.provide('mathbox.primitives.draw.strip');
 ...
 */
mathbox.primitives.draw.strip.Strip = reagent.core.adapt_react_class(module$node_modules$mathbox_react$build$cjs$index.Strip);

//# sourceMappingURL=mathbox.primitives.draw.strip.js.map
