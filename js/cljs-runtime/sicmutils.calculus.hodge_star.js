...
var G__87928 = cljs.core.rest(ins);
var G__87929 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(outs,normalize(sicmutils.generic._.cljs$core$IFn$_invoke$arity$2(cljs.core.first(ins),cljs.core.apply.cljs$core$IFn$_invoke$arity$2(sicmutils.generic._PLUS_,cljs.core.map.cljs$core$IFn$_invoke$arity$2(((function (ins,outs,vects,e0){
return (function (outv){
return sicmutils.generic._STAR_.cljs$core$IFn$_invoke$arity$2((function (){var G__87904 = cljs.core.first(ins);
var G__87905 = outv;
return (metric.cljs$core$IFn$_invoke$arity$2 ? metric.cljs$core$IFn$_invoke$arity$2(G__87904,G__87905) : metric.call(null,G__87904,G__87905));
})(),outv);
});})(ins,outs,vects,e0))
,outs)))));
ins = G__87928;
...
var len__4864__auto___87937 = arguments.length;
var i__4865__auto___87939 = (0);
while(true){
if((i__4865__auto___87939 < len__4864__auto___87937)){
args__4870__auto__.push((arguments[i__4865__auto___87939]));

var G__87940 = (i__4865__auto___87939 + (1));
i__4865__auto___87939 = G__87940;
continue;
} else {
}
break;
...
(sicmutils.calculus.hodge_star.Hodge_star.cljs$core$IFn$_invoke$arity$variadic = (function (metric,spec,p__87919){
var map__87921 = p__87919;
var map__87921__$1 = cljs.core.__destructure_map(map__87921);
var orthonormalize_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__87921__$1,new cljs.core.Keyword(null,"orthonormalize?","orthonormalize?",-11872752),false);
...
/** @this {Function} */
(sicmutils.calculus.hodge_star.Hodge_star.cljs$lang$applyTo = (function (seq87910){
var G__87911 = cljs.core.first(seq87910);
var seq87910__$1 = cljs.core.next(seq87910);
var G__87912 = cljs.core.first(seq87910__$1);
var seq87910__$2 = cljs.core.next(seq87910__$1);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__87911,G__87912,seq87910__$2);
}));
