...
3));this.setAttribute("normal",new _BufferAttribute.Float32BufferAttribute(normals,3));this.setAttribute("uv",new _BufferAttribute.Float32BufferAttribute(uvs,2))}static fromJSON(data){return new PlaneGeometry(data.width,data.height,data.widthSegments,data.heightSegments)}}exports.PlaneGeometry=PlaneGeometry}
