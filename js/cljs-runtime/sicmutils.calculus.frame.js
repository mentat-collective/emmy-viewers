...
var sicmutils$calculus$frame$IFrame$coords__GT_event$dyn_87118 = (function (this$,coords){
...
return sicmutils$calculus$frame$IFrame$coords__GT_event$dyn_87118(this$,coords);
}
});

var sicmutils$calculus$frame$IFrame$event__GT_coords$dyn_87123 = (function (this$,event){
var x__4550__auto__ = (((this$ == null))?null:this$);
...
return sicmutils$calculus$frame$IFrame$event__GT_coords$dyn_87123(this$,event);
}
});

var sicmutils$calculus$frame$IFrame$ancestor_frame$dyn_87126 = (function (_){
...
return sicmutils$calculus$frame$IFrame$ancestor_frame$dyn_87126(_);
}
});

var sicmutils$calculus$frame$IFrame$frame_name$dyn_87127 = (function (_){
var x__4550__auto__ = (((_ == null))?null:_);
...
return sicmutils$calculus$frame$IFrame$frame_name$dyn_87127(_);
}
});

var sicmutils$calculus$frame$IFrame$params$dyn_87128 = (function (_){
var x__4550__auto__ = (((_ == null))?null:_);
...
return sicmutils$calculus$frame$IFrame$params$dyn_87128(_);
}
});
...
if((typeof sicmutils !== 'undefined') && (typeof sicmutils.calculus !== 'undefined') && (typeof sicmutils.calculus.frame !== 'undefined') && (typeof sicmutils.calculus.frame.t_sicmutils$calculus$frame87040 !== 'undefined')){
} else {
...
*/
sicmutils.calculus.frame.t_sicmutils$calculus$frame87040 = (function (c__GT_e,e__GT_c,call,name,ancestor_frame,params,meta87041){
...
this.params = params;
this.meta87041 = meta87041;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(sicmutils.calculus.frame.t_sicmutils$calculus$frame87040.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_87042,meta87041__$1){
var self__ = this;
var _87042__$1 = this;
return (new sicmutils.calculus.frame.t_sicmutils$calculus$frame87040(self__.c__GT_e,self__.e__GT_c,self__.call,self__.name,self__.ancestor_frame,self__.params,meta87041__$1));
}));

(sicmutils.calculus.frame.t_sicmutils$calculus$frame87040.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_87042){
var self__ = this;
var _87042__$1 = this;
return self__.meta87041;
}));

(sicmutils.calculus.frame.t_sicmutils$calculus$frame87040.prototype.sicmutils$calculus$frame$IFrame$ = cljs.core.PROTOCOL_SENTINEL);

(sicmutils.calculus.frame.t_sicmutils$calculus$frame87040.prototype.sicmutils$calculus$frame$IFrame$ancestor_frame$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
return self__.ancestor_frame;
}));

(sicmutils.calculus.frame.t_sicmutils$calculus$frame87040.prototype.sicmutils$calculus$frame$IFrame$frame_name$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
return self__.name;
}));

(sicmutils.calculus.frame.t_sicmutils$calculus$frame87040.prototype.sicmutils$calculus$frame$IFrame$params$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
return self__.params;
}));

(sicmutils.calculus.frame.t_sicmutils$calculus$frame87040.prototype.sicmutils$calculus$frame$IFrame$coords__GT_event$arity$2 = (function (this$,coords){
var self__ = this;
var this$__$1 = this;
...
var event = (function (){var fexpr__87051 = (self__.c__GT_e.cljs$core$IFn$_invoke$arity$3 ? self__.c__GT_e.cljs$core$IFn$_invoke$arity$3(self__.ancestor_frame,this$__$1,self__.params) : self__.c__GT_e.call(null,self__.ancestor_frame,this$__$1,self__.params));
return (fexpr__87051.cljs$core$IFn$_invoke$arity$1 ? fexpr__87051.cljs$core$IFn$_invoke$arity$1(coords) : fexpr__87051.call(null,coords));
})();
...
(sicmutils.calculus.frame.t_sicmutils$calculus$frame87040.prototype.sicmutils$calculus$frame$IFrame$event__GT_coords$arity$2 = (function (this$,event){
var self__ = this;
var this$__$1 = this;
if(cljs.core.truth_(sicmutils.calculus.frame.event_QMARK_(event))){
} else {
...
var coords = (function (){var fexpr__87055 = (self__.e__GT_c.cljs$core$IFn$_invoke$arity$3 ? self__.e__GT_c.cljs$core$IFn$_invoke$arity$3(self__.ancestor_frame,this$__$1,self__.params) : self__.e__GT_c.call(null,self__.ancestor_frame,this$__$1,self__.params));
return (fexpr__87055.cljs$core$IFn$_invoke$arity$1 ? fexpr__87055.cljs$core$IFn$_invoke$arity$1(event) : fexpr__87055.call(null,event));
})();
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(sicmutils.calculus.frame.frame_owner(coords),this$__$1)){
} else {
throw (new Error("Assert failed: (= (frame-owner coords) this)"));
...
(sicmutils.calculus.frame.t_sicmutils$calculus$frame87040.getBasis = (function (){
return new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"c->e","c->e",366611773,null),new cljs.core.Symbol(null,"e->c","e->c",-1459982439,null),new cljs.core.Symbol(null,"call","call",1120531661,null),new cljs.core.Symbol(null,"name","name",-810760592,null),new cljs.core.Symbol(null,"ancestor-frame","ancestor-frame",-1796645653,null),new cljs.core.Symbol(null,"params","params",-1943919534,null),new cljs.core.Symbol(null,"meta87041","meta87041",148501699,null)], null);
}));

(sicmutils.calculus.frame.t_sicmutils$calculus$frame87040.cljs$lang$type = true);

(sicmutils.calculus.frame.t_sicmutils$calculus$frame87040.cljs$lang$ctorStr = "sicmutils.calculus.frame/t_sicmutils$calculus$frame87040");

(sicmutils.calculus.frame.t_sicmutils$calculus$frame87040.cljs$lang$ctorPrWriter = (function (this__4491__auto__,writer__4492__auto__,opt__4493__auto__){
return cljs.core._write(writer__4492__auto__,"sicmutils.calculus.frame/t_sicmutils$calculus$frame87040");
}));

/**
 * Positional factory function for sicmutils.calculus.frame/t_sicmutils$calculus$frame87040.
 */
sicmutils.calculus.frame.__GT_t_sicmutils$calculus$frame87040 = (function sicmutils$calculus$frame$frame_maker_$_call_$___GT_t_sicmutils$calculus$frame87040(c__GT_e__$1,e__GT_c__$1,call__$1,name__$1,ancestor_frame__$1,params__$1,meta87041){
return (new sicmutils.calculus.frame.t_sicmutils$calculus$frame87040(c__GT_e__$1,e__GT_c__$1,call__$1,name__$1,ancestor_frame__$1,params__$1,meta87041));
});

}

return (new sicmutils.calculus.frame.t_sicmutils$calculus$frame87040(c__GT_e,e__GT_c,sicmutils$calculus$frame$frame_maker_$_call,name,ancestor_frame,params,cljs.core.PersistentArrayMap.EMPTY));
});
