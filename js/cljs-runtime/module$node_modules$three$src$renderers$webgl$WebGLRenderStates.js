...
camera)},pushLight:function(light){lightsArray.push(light)},pushShadow:function(shadowLight){shadowsArray.push(shadowLight)}}}Object.defineProperty(exports,"__esModule",{value:!0});exports.WebGLRenderStates=function(extensions,capabilities){let renderStates=new WeakMap;return{get:function(scene,renderCallDepth=0){const renderStateArray=renderStates.get(scene);void 0===renderStateArray?(renderCallDepth=new WebGLRenderState(extensions,capabilities),renderStates.set(scene,[renderCallDepth])):renderCallDepth>=
renderStateArray.length?(renderCallDepth=new WebGLRenderState(extensions,capabilities),renderStateArray.push(renderCallDepth)):renderCallDepth=renderStateArray[renderCallDepth];return renderCallDepth},dispose:function(){renderStates=new WeakMap}}};var _WebGLLights=require("module$node_modules$three$src$renderers$webgl$WebGLLights")}
