 ...
 *  is called.
 */
sicmutils.numerical.ode.integration_opts = (function sicmutils$numerical$ode$integration_opts(state_derivative,derivative_args,initial_state,p__81758){
var map__81759 = p__81758;
var map__81759__$1 = cljs.core.__destructure_map(map__81759);
var compile_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__81759__$1,new cljs.core.Keyword(null,"compile?","compile?",-826687650));
var epsilon = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__81759__$1,new cljs.core.Keyword(null,"epsilon","epsilon",-730158570),1.0E-8);
...
}),null)),null,-998284224,null);

var d_COLON_dt = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(state_derivative,derivative_args);
var array__GT_state = (function (p1__81757_SHARP_){
return sicmutils.structure.unflatten.cljs$core$IFn$_invoke$arity$2(p1__81757_SHARP_,initial_state);
});
...
var sicmutils$numerical$ode$make_integrator_$_call__4 = (function (initial_state,step_size,t,p__81762){
var map__81763 = p__81762;
var map__81763__$1 = cljs.core.__destructure_map(map__81763);
var opts = map__81763__$1;
var observe = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__81763__$1,new cljs.core.Keyword(null,"observe","observe",-86651450));
total_time.sicmutils$util$stopwatch$IStopwatch$start$arity$1(null);

var map__81764 = sicmutils.numerical.ode.integration_opts(state_derivative,derivative_args,initial_state,opts);
var map__81764__$1 = cljs.core.__destructure_map(map__81764);
var integrator = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__81764__$1,new cljs.core.Keyword(null,"integrator","integrator",1554489822));
var equations = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__81764__$1,new cljs.core.Keyword(null,"equations","equations",1884238648));
var stopwatch__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__81764__$1,new cljs.core.Keyword(null,"stopwatch","stopwatch",1391653038));
var counter = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__81764__$1,new cljs.core.Keyword(null,"counter","counter",804008177));
var initial_state_array = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.flatten(initial_state));
var array__GT_state = (function (p1__81760_SHARP_){
return sicmutils.structure.unflatten.cljs$core$IFn$_invoke$arity$2(p1__81760_SHARP_,initial_state);
});
...
var G__81765 = t__$1;
var G__81766 = array__GT_state(y);
return (observe.cljs$core$IFn$_invoke$arity$2 ? observe.cljs$core$IFn$_invoke$arity$2(G__81765,G__81766) : observe.call(null,G__81765,G__81766));
}));
})()
:null);
...
sicmutils$numerical$ode$make_integrator_$_call = function(initial_state,step_size,t,p__81762){
switch(arguments.length){
case 3:
return sicmutils$numerical$ode$make_integrator_$_call__3.call(this,initial_state,step_size,t);
case 4:
return sicmutils$numerical$ode$make_integrator_$_call__4.call(this,initial_state,step_size,t,p__81762);
}
...
var len__4864__auto___81789 = arguments.length;
var i__4865__auto___81790 = (0);
while(true){
if((i__4865__auto___81790 < len__4864__auto___81789)){
args__4870__auto__.push((arguments[i__4865__auto___81790]));

var G__81791 = (i__4865__auto___81790 + (1));
i__4865__auto___81790 = G__81791;
continue;
} else {
}
break;
...
/** @this {Function} */
(sicmutils.numerical.ode.state_advancer.cljs$lang$applyTo = (function (seq81768){
var G__81769 = cljs.core.first(seq81768);
var seq81768__$1 = cljs.core.next(seq81768);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__81769,seq81768__$1);
}));
...
var args__4870__auto__ = [];
var len__4864__auto___81794 = arguments.length;
var i__4865__auto___81795 = (0);
while(true){
if((i__4865__auto___81795 < len__4864__auto___81794)){
args__4870__auto__.push((arguments[i__4865__auto___81795]));

var G__81796 = (i__4865__auto___81795 + (1));
i__4865__auto___81795 = G__81796;
continue;
} else {
}
break;
...
/** @this {Function} */
(sicmutils.numerical.ode.evolve.cljs$lang$applyTo = (function (seq81773){
var G__81774 = cljs.core.first(seq81773);
var seq81773__$1 = cljs.core.next(seq81773);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__81774,seq81773__$1);
}));
