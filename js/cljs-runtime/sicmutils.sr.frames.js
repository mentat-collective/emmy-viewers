...
sicmutils.sr.frames.coordinates__GT_event = (function sicmutils$sr$frames$coordinates__GT_event(ancestor_frame,_,p__103556){
var map__103557 = p__103556;
var map__103557__$1 = cljs.core.__destructure_map(map__103557);
var boost_direction = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__103557__$1,new cljs.core.Keyword(null,"boost-direction","boost-direction",-1975902118));
var vc = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__103557__$1,new cljs.core.Keyword(null,"vc","vc",194349650));
var origin = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__103557__$1,new cljs.core.Keyword(null,"origin","origin",1037372088));
...
sicmutils.sr.frames.event__GT_coordinates = (function sicmutils$sr$frames$event__GT_coordinates(ancestor_frame,this_frame,p__103558){
var map__103559 = p__103558;
var map__103559__$1 = cljs.core.__destructure_map(map__103559);
var boost_direction = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__103559__$1,new cljs.core.Keyword(null,"boost-direction","boost-direction",-1975902118));
var vc = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__103559__$1,new cljs.core.Keyword(null,"vc","vc",194349650));
var origin = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__103559__$1,new cljs.core.Keyword(null,"origin","origin",1037372088));
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(sicmutils.calculus.frame.frame_owner(origin),ancestor_frame)){
} else {
throw (new Error("Assert failed: (= (cf/frame-owner origin) ancestor-frame)"));
}
...
var make_103614 = sicmutils.calculus.frame.frame_maker(sicmutils.sr.frames.coordinates__GT_event,sicmutils.sr.frames.event__GT_coordinates);
...
return make_103614(name,ancestor_frame,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"boost-direction","boost-direction",-1975902118),boost_direction,new cljs.core.Keyword(null,"vc","vc",194349650),v_over_c,new cljs.core.Keyword(null,"origin","origin",1037372088),origin], null));
});
