...
sicmutils.sr.frames.coordinates__GT_event = (function sicmutils$sr$frames$coordinates__GT_event(ancestor_frame,_,p__103663){
var map__103664 = p__103663;
var map__103664__$1 = cljs.core.__destructure_map(map__103664);
var boost_direction = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__103664__$1,new cljs.core.Keyword(null,"boost-direction","boost-direction",-1975902118));
var vc = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__103664__$1,new cljs.core.Keyword(null,"vc","vc",194349650));
var origin = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__103664__$1,new cljs.core.Keyword(null,"origin","origin",1037372088));
...
sicmutils.sr.frames.event__GT_coordinates = (function sicmutils$sr$frames$event__GT_coordinates(ancestor_frame,this_frame,p__103667){
var map__103668 = p__103667;
var map__103668__$1 = cljs.core.__destructure_map(map__103668);
var boost_direction = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__103668__$1,new cljs.core.Keyword(null,"boost-direction","boost-direction",-1975902118));
var vc = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__103668__$1,new cljs.core.Keyword(null,"vc","vc",194349650));
var origin = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__103668__$1,new cljs.core.Keyword(null,"origin","origin",1037372088));
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(sicmutils.calculus.frame.frame_owner(origin),ancestor_frame)){
} else {
throw (new Error("Assert failed: (= (cf/frame-owner origin) ancestor-frame)"));
}
...
var make_103691 = sicmutils.calculus.frame.frame_maker(sicmutils.sr.frames.coordinates__GT_event,sicmutils.sr.frames.event__GT_coordinates);
...
return make_103691(name,ancestor_frame,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"boost-direction","boost-direction",-1975902118),boost_direction,new cljs.core.Keyword(null,"vc","vc",194349650),v_over_c,new cljs.core.Keyword(null,"origin","origin",1037372088),origin], null));
});
