shadow$provide.module$node_modules$three$src$renderers$WebGLRenderer=function(global,require,module,exports){function createCanvasElement(){const canvas=(0,_utils.createElementNS)("canvas");canvas.style.display="block";return canvas}Object.defineProperty(exports,"__esModule",{value:!0});exports.WebGLRenderer=function(parameters$jscomp$0={}){function getContext(contextNames,contextAttributes){for(let i=0;i<contextNames.length;i++){const context=_canvas.getContext(contextNames[i],contextAttributes);
if(null!==context)return context}return null}function initGLContext(){extensions=new _WebGLExtensions.WebGLExtensions(_gl);capabilities=new _WebGLCapabilities.WebGLCapabilities(_gl,extensions,parameters$jscomp$0);extensions.init(capabilities);utils=new _WebGLUtils.WebGLUtils(_gl,extensions,capabilities);state=new _WebGLState.WebGLState(_gl,extensions,capabilities);info=new _WebGLInfo.WebGLInfo(_gl);properties=new _WebGLProperties.WebGLProperties;textures=new _WebGLTextures.WebGLTextures(_gl,extensions,
state,properties,capabilities,utils,info);cubemaps=new _WebGLCubeMaps.WebGLCubeMaps(_this);cubeuvmaps=new _WebGLCubeUVMaps.WebGLCubeUVMaps(_this);attributes=new _WebGLAttributes.WebGLAttributes(_gl,capabilities);bindingStates=new _WebGLBindingStates.WebGLBindingStates(_gl,extensions,attributes,capabilities);geometries=new _WebGLGeometries.WebGLGeometries(_gl,attributes,info,bindingStates);objects=new _WebGLObjects.WebGLObjects(_gl,geometries,attributes,info);morphtargets=new _WebGLMorphtargets.WebGLMorphtargets(_gl,
capabilities,textures);clipping=new _WebGLClipping.WebGLClipping(properties);programCache=new _WebGLPrograms.WebGLPrograms(_this,cubemaps,cubeuvmaps,extensions,capabilities,bindingStates,clipping);materials=new _WebGLMaterials.WebGLMaterials(_this,properties);renderLists=new _WebGLRenderLists.WebGLRenderLists;renderStates=new _WebGLRenderStates.WebGLRenderStates(extensions,capabilities);background=new _WebGLBackground.WebGLBackground(_this,cubemaps,cubeuvmaps,state,objects,_alpha,_premultipliedAlpha);
shadowMap=new _WebGLShadowMap.WebGLShadowMap(_this,objects,capabilities);uniformsGroups=new _WebGLUniformsGroups.WebGLUniformsGroups(_gl,info,capabilities,state);bufferRenderer=new _WebGLBufferRenderer.WebGLBufferRenderer(_gl,extensions,info,capabilities);indexedBufferRenderer=new _WebGLIndexedBufferRenderer.WebGLIndexedBufferRenderer(_gl,extensions,info,capabilities);info.programs=programCache.programs;_this.capabilities=capabilities;_this.extensions=extensions;_this.properties=properties;_this.renderLists=
renderLists;_this.shadowMap=shadowMap;_this.state=state;_this.info=info}function onContextLost(event){event.preventDefault();console.log("THREE.WebGLRenderer: Context Lost.");_isContextLost=!0}function onContextRestore(){console.log("THREE.WebGLRenderer: Context Restored.");_isContextLost=!1;const infoAutoReset=info.autoReset,shadowMapEnabled=shadowMap.enabled,shadowMapAutoUpdate=shadowMap.autoUpdate,shadowMapNeedsUpdate=shadowMap.needsUpdate,shadowMapType=shadowMap.type;initGLContext();info.autoReset=
infoAutoReset;shadowMap.enabled=shadowMapEnabled;shadowMap.autoUpdate=shadowMapAutoUpdate;shadowMap.needsUpdate=shadowMapNeedsUpdate;shadowMap.type=shadowMapType}function onContextCreationError(event){console.error("THREE.WebGLRenderer: A WebGL context could not be created. Reason: ",event.statusMessage)}function onMaterialDispose(event){event=event.target;event.removeEventListener("dispose",onMaterialDispose);releaseMaterialProgramReferences(event);properties.remove(event)}function releaseMaterialProgramReferences(material){const programs=
properties.get(material).programs;void 0!==programs&&(programs.forEach(function(program){programCache.releaseProgram(program)}),material.isShaderMaterial&&programCache.releaseShaderCache(material))}function onXRSessionStart(){animation.stop()}function onXRSessionEnd(){animation.start()}function projectObject(object,camera,groupOrder,sortObjects){if(!1!==object.visible){if(object.layers.test(camera.layers))if(object.isGroup)groupOrder=object.renderOrder;else if(object.isLOD)!0===object.autoUpdate&&
object.update(camera);else if(object.isLight)currentRenderState.pushLight(object),object.castShadow&&currentRenderState.pushShadow(object);else if(object.isSprite){if(!object.frustumCulled||_frustum.intersectsSprite(object)){sortObjects&&_vector3.setFromMatrixPosition(object.matrixWorld).applyMatrix4(_projScreenMatrix);var geometry=objects.update(object),material=object.material;material.visible&&currentRenderList$jscomp$0.push(object,geometry,material,groupOrder,_vector3.z,null)}}else if(object.isMesh||
object.isLine||object.isPoints)if(object.isSkinnedMesh&&object.skeleton.frame!==info.render.frame&&(object.skeleton.update(),object.skeleton.frame=info.render.frame),!object.frustumCulled||_frustum.intersectsObject(object))if(sortObjects&&_vector3.setFromMatrixPosition(object.matrixWorld).applyMatrix4(_projScreenMatrix),geometry=objects.update(object),material=object.material,Array.isArray(material)){const groups=geometry.groups;for(let i=0,l=groups.length;i<l;i++){const group=groups[i],groupMaterial=
material[group.materialIndex];groupMaterial&&groupMaterial.visible&&currentRenderList$jscomp$0.push(object,geometry,groupMaterial,groupOrder,_vector3.z,group)}}else material.visible&&currentRenderList$jscomp$0.push(object,geometry,material,groupOrder,_vector3.z,null);object=object.children;for(let i=0,l=object.length;i<l;i++)projectObject(object[i],camera,groupOrder,sortObjects)}}function renderScene(currentRenderList,scene,camera,viewport){const opaqueObjects=currentRenderList.opaque,transmissiveObjects=
currentRenderList.transmissive;currentRenderList=currentRenderList.transparent;currentRenderState.setupLightsView(camera);if(0<transmissiveObjects.length){var isWebGL2=capabilities.isWebGL2;null===_transmissionRenderTarget&&(_transmissionRenderTarget=new _WebGLRenderTarget.WebGLRenderTarget(1,1,{generateMipmaps:!0,type:extensions.has("EXT_color_buffer_half_float")?_constants.HalfFloatType:_constants.UnsignedByteType,minFilter:_constants.LinearMipmapLinearFilter,samples:isWebGL2&&!0===_antialias?4:
0}));_this.getDrawingBufferSize(_vector2);isWebGL2?_transmissionRenderTarget.setSize(_vector2.x,_vector2.y):_transmissionRenderTarget.setSize((0,_MathUtils.floorPowerOfTwo)(_vector2.x),(0,_MathUtils.floorPowerOfTwo)(_vector2.y));isWebGL2=_this.getRenderTarget();_this.setRenderTarget(_transmissionRenderTarget);_this.clear();const currentToneMapping=_this.toneMapping;_this.toneMapping=_constants.NoToneMapping;renderObjects(opaqueObjects,scene,camera);_this.toneMapping=currentToneMapping;textures.updateMultisampleRenderTarget(_transmissionRenderTarget);
textures.updateRenderTargetMipmap(_transmissionRenderTarget);_this.setRenderTarget(isWebGL2)}viewport&&state.viewport(_currentViewport.copy(viewport));0<opaqueObjects.length&&renderObjects(opaqueObjects,scene,camera);0<transmissiveObjects.length&&renderObjects(transmissiveObjects,scene,camera);0<currentRenderList.length&&renderObjects(currentRenderList,scene,camera);state.buffers.depth.setTest(!0);state.buffers.depth.setMask(!0);state.buffers.color.setMask(!0);state.setPolygonOffset(!1)}function renderObjects(renderList,
...
_failIfMajorPerformanceCaveat=void 0!==parameters$jscomp$0.failIfMajorPerformanceCaveat?parameters$jscomp$0.failIfMajorPerformanceCaveat:!1;let _alpha;_alpha=null!==_context?_context.getContextAttributes().alpha:void 0!==parameters$jscomp$0.alpha?parameters$jscomp$0.alpha:!1;let currentRenderList$jscomp$0=null,currentRenderState=null;const renderListStack=[],renderStateStack=[];this.domElement=_canvas;this.debug={checkShaderErrors:!0};this.sortObjects=this.autoClearStencil=this.autoClearDepth=this.autoClearColor=
this.autoClear=!0;this.clippingPlanes=[];this.localClippingEnabled=!1;this.outputEncoding=_constants.LinearEncoding;this.physicallyCorrectLights=!1;this.toneMapping=_constants.NoToneMapping;this.toneMappingExposure=1;Object.defineProperties(this,{gammaFactor:{get:function(){console.warn("THREE.WebGLRenderer: .gammaFactor has been removed.");return 2},set:function(){console.warn("THREE.WebGLRenderer: .gammaFactor has been removed.")}}});const _this=this;let _isContextLost=!1,_currentActiveCubeFace=
0,_currentActiveMipmapLevel=0,_currentRenderTarget=null,_currentMaterialId=-1,_currentCamera=null;const _currentViewport=new _Vector3.Vector4,_currentScissor=new _Vector3.Vector4;let _currentScissorTest=null,_width=_canvas.width,_height=_canvas.height,_pixelRatio=1,_opaqueSort=null,_transparentSort=null;const _viewport=new _Vector3.Vector4(0,0,_width,_height),_scissor=new _Vector3.Vector4(0,0,_width,_height);let _scissorTest=!1;const _frustum=new _Frustum.Frustum;let _clippingEnabled=!1,_localClippingEnabled=
!1,_transmissionRenderTarget=null;const _projScreenMatrix=new _Matrix.Matrix4,_vector2=new _Vector.Vector2,_vector3=new _Vector2.Vector3,_emptyScene={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let _gl=_context;try{_context={alpha:!0,depth:_depth,stencil:_stencil,antialias:_antialias,premultipliedAlpha:_premultipliedAlpha,preserveDrawingBuffer:_preserveDrawingBuffer,powerPreference:_powerPreference,failIfMajorPerformanceCaveat:_failIfMajorPerformanceCaveat};"setAttribute"in
_canvas&&_canvas.setAttribute("data-engine",`three.js r${_constants.REVISION}`);_canvas.addEventListener("webglcontextlost",onContextLost,!1);_canvas.addEventListener("webglcontextrestored",onContextRestore,!1);_canvas.addEventListener("webglcontextcreationerror",onContextCreationError,!1);if(null===_gl&&(_depth=["webgl2","webgl","experimental-webgl"],!0===_this.isWebGL1Renderer&&_depth.shift(),_gl=getContext(_depth,_context),null===_gl)){if(getContext(_depth))throw Error("Error creating WebGL context with your selected attributes.");
...
uniformsGroups;initGLContext();const xr=new _WebXRManager.WebXRManager(_this,_gl);this.xr=xr;this.getContext=function(){return _gl};this.getContextAttributes=function(){return _gl.getContextAttributes()};this.forceContextLoss=function(){const extension=extensions.get("WEBGL_lose_context");extension&&extension.loseContext()};this.forceContextRestore=function(){const extension=extensions.get("WEBGL_lose_context");extension&&extension.restoreContext()};this.getPixelRatio=function(){return _pixelRatio};
this.setPixelRatio=function(value){void 0!==value&&(_pixelRatio=value,this.setSize(_width,_height,!1))};this.getSize=function(target){return target.set(_width,_height)};this.setSize=function(width,height,updateStyle){xr.isPresenting?console.warn("THREE.WebGLRenderer: Can't change size while VR device is presenting."):(_width=width,_height=height,_canvas.width=Math.floor(width*_pixelRatio),_canvas.height=Math.floor(height*_pixelRatio),!1!==updateStyle&&(_canvas.style.width=width+"px",_canvas.style.height=
height+"px"),this.setViewport(0,0,width,height))};this.getDrawingBufferSize=function(target){return target.set(_width*_pixelRatio,_height*_pixelRatio).floor()};this.setDrawingBufferSize=function(width,height,pixelRatio){_width=width;_height=height;_pixelRatio=pixelRatio;_canvas.width=Math.floor(width*pixelRatio);_canvas.height=Math.floor(height*pixelRatio);this.setViewport(0,0,width,height)};this.getCurrentViewport=function(target){return target.copy(_currentViewport)};this.getViewport=function(target){return target.copy(_viewport)};
...
arguments)};this.clear=function(color=!0,depth=!0,stencil=!0){let bits=0;color&&(bits|=_gl.COLOR_BUFFER_BIT);depth&&(bits|=_gl.DEPTH_BUFFER_BIT);stencil&&(bits|=_gl.STENCIL_BUFFER_BIT);_gl.clear(bits)};this.clearColor=function(){this.clear(!0,!1,!1)};this.clearDepth=function(){this.clear(!1,!0,!1)};this.clearStencil=function(){this.clear(!1,!1,!0)};this.dispose=function(){_canvas.removeEventListener("webglcontextlost",onContextLost,!1);_canvas.removeEventListener("webglcontextrestored",onContextRestore,
!1);_canvas.removeEventListener("webglcontextcreationerror",onContextCreationError,!1);renderLists.dispose();renderStates.dispose();properties.dispose();cubemaps.dispose();cubeuvmaps.dispose();objects.dispose();bindingStates.dispose();uniformsGroups.dispose();programCache.dispose();xr.dispose();xr.removeEventListener("sessionstart",onXRSessionStart);xr.removeEventListener("sessionend",onXRSessionEnd);_transmissionRenderTarget&&(_transmissionRenderTarget.dispose(),_transmissionRenderTarget=null);animation.stop()};
this.renderBufferDirect=function(camera,scene$jscomp$0,geometry,material,object,group){null===scene$jscomp$0&&(scene$jscomp$0=_emptyScene);var frontFaceCW=object.isMesh&&0>object.matrixWorld.determinant(),scene=scene$jscomp$0;!0!==scene.isScene&&(scene=_emptyScene);textures.resetTextureUnits();scene$jscomp$0=scene.fog;var environment=material.isMeshStandardMaterial?scene.environment:null,encoding=null===_currentRenderTarget?_this.outputEncoding:!0===_currentRenderTarget.isXRRenderTarget?_currentRenderTarget.texture.encoding:
_constants.LinearEncoding;environment=(material.isMeshStandardMaterial?cubeuvmaps:cubemaps).get(material.envMap||environment);var vertexAlphas=!0===material.vertexColors&&!!geometry.attributes.color&&4===geometry.attributes.color.itemSize,vertexTangents=!!material.normalMap&&!!geometry.attributes.tangent,morphTargets=!!geometry.morphAttributes.position,morphNormals=!!geometry.morphAttributes.normal;const morphColors=!!geometry.morphAttributes.color,toneMapping=material.toneMapped?_this.toneMapping:
_constants.NoToneMapping;var JSCompiler_inline_result=geometry.morphAttributes.position||geometry.morphAttributes.normal||geometry.morphAttributes.color;const morphTargetsCount=void 0!==JSCompiler_inline_result?JSCompiler_inline_result.length:0;JSCompiler_inline_result=properties.get(material);const lights=currentRenderState.state.lights;!0!==_clippingEnabled||!0!==_localClippingEnabled&&camera===_currentCamera||clipping.setState(material,camera,camera===_currentCamera&&material.id===_currentMaterialId);
let needsProgramChange=!1;material.version===JSCompiler_inline_result.__version?JSCompiler_inline_result.needsLights&&JSCompiler_inline_result.lightsStateVersion!==lights.state.version?needsProgramChange=!0:JSCompiler_inline_result.outputEncoding!==encoding?needsProgramChange=!0:object.isInstancedMesh&&!1===JSCompiler_inline_result.instancing?needsProgramChange=!0:object.isInstancedMesh||!0!==JSCompiler_inline_result.instancing?object.isSkinnedMesh&&!1===JSCompiler_inline_result.skinning?needsProgramChange=
!0:object.isSkinnedMesh||!0!==JSCompiler_inline_result.skinning?JSCompiler_inline_result.envMap!==environment?needsProgramChange=!0:!0===material.fog&&JSCompiler_inline_result.fog!==scene$jscomp$0?needsProgramChange=!0:void 0===JSCompiler_inline_result.numClippingPlanes||JSCompiler_inline_result.numClippingPlanes===clipping.numPlanes&&JSCompiler_inline_result.numIntersection===clipping.numIntersection?JSCompiler_inline_result.vertexAlphas!==vertexAlphas?needsProgramChange=!0:JSCompiler_inline_result.vertexTangents!==
vertexTangents?needsProgramChange=!0:JSCompiler_inline_result.morphTargets!==morphTargets?needsProgramChange=!0:JSCompiler_inline_result.morphNormals!==morphNormals?needsProgramChange=!0:JSCompiler_inline_result.morphColors!==morphColors?needsProgramChange=!0:JSCompiler_inline_result.toneMapping!==toneMapping?needsProgramChange=!0:!0===capabilities.isWebGL2&&JSCompiler_inline_result.morphTargetsCount!==morphTargetsCount&&(needsProgramChange=!0):needsProgramChange=!0:needsProgramChange=!0:needsProgramChange=
!0:(needsProgramChange=!0,JSCompiler_inline_result.__version=material.version);encoding=JSCompiler_inline_result.currentProgram;!0===needsProgramChange&&(encoding=getProgram(material,scene,object));morphTargets=vertexTangents=morphNormals=!1;scene=encoding.getUniforms();vertexAlphas=JSCompiler_inline_result.uniforms;state.useProgram(encoding.program)&&(morphTargets=vertexTangents=morphNormals=!0);material.id!==_currentMaterialId&&(_currentMaterialId=material.id,vertexTangents=!0);if(morphNormals||
_currentCamera!==camera){scene.setValue(_gl,"projectionMatrix",camera.projectionMatrix);capabilities.logarithmicDepthBuffer&&scene.setValue(_gl,"logDepthBufFC",2/(Math.log(camera.far+1)/Math.LN2));_currentCamera!==camera&&(_currentCamera=camera,morphTargets=vertexTangents=!0);if(material.isShaderMaterial||material.isMeshPhongMaterial||material.isMeshToonMaterial||material.isMeshStandardMaterial||material.envMap)morphNormals=scene.map.cameraPosition,void 0!==morphNormals&&morphNormals.setValue(_gl,
_vector3.setFromMatrixPosition(camera.matrixWorld));(material.isMeshPhongMaterial||material.isMeshToonMaterial||material.isMeshLambertMaterial||material.isMeshBasicMaterial||material.isMeshStandardMaterial||material.isShaderMaterial)&&scene.setValue(_gl,"isOrthographic",!0===camera.isOrthographicCamera);(material.isMeshPhongMaterial||material.isMeshToonMaterial||material.isMeshLambertMaterial||material.isMeshBasicMaterial||material.isMeshStandardMaterial||material.isShaderMaterial||material.isShadowMaterial||
object.isSkinnedMesh)&&scene.setValue(_gl,"viewMatrix",camera.matrixWorldInverse)}object.isSkinnedMesh&&(scene.setOptional(_gl,object,"bindMatrix"),scene.setOptional(_gl,object,"bindMatrixInverse"),camera=object.skeleton)&&(capabilities.floatVertexTextures?(null===camera.boneTexture&&camera.computeBoneTexture(),scene.setValue(_gl,"boneTexture",camera.boneTexture,textures),scene.setValue(_gl,"boneTextureSize",camera.boneTextureSize)):console.warn("THREE.WebGLRenderer: SkinnedMesh can only be used with WebGL 2. With WebGL 1 OES_texture_float and vertex textures support is required."));
camera=geometry.morphAttributes;(void 0!==camera.position||void 0!==camera.normal||void 0!==camera.color&&!0===capabilities.isWebGL2)&&morphtargets.update(object,geometry,material,encoding);if(vertexTangents||JSCompiler_inline_result.receiveShadow!==object.receiveShadow)JSCompiler_inline_result.receiveShadow=object.receiveShadow,scene.setValue(_gl,"receiveShadow",object.receiveShadow);material.isMeshGouraudMaterial&&null!==material.envMap&&(vertexAlphas.envMap.value=environment,vertexAlphas.flipEnvMap.value=
environment.isCubeTexture&&!1===environment.isRenderTargetTexture?-1:1);vertexTangents&&(scene.setValue(_gl,"toneMappingExposure",_this.toneMappingExposure),JSCompiler_inline_result.needsLights&&(camera=morphTargets,vertexAlphas.ambientLightColor.needsUpdate=camera,vertexAlphas.lightProbe.needsUpdate=camera,vertexAlphas.directionalLights.needsUpdate=camera,vertexAlphas.directionalLightShadows.needsUpdate=camera,vertexAlphas.pointLights.needsUpdate=camera,vertexAlphas.pointLightShadows.needsUpdate=
camera,vertexAlphas.spotLights.needsUpdate=camera,vertexAlphas.spotLightShadows.needsUpdate=camera,vertexAlphas.rectAreaLights.needsUpdate=camera,vertexAlphas.hemisphereLights.needsUpdate=camera),scene$jscomp$0&&!0===material.fog&&materials.refreshFogUniforms(vertexAlphas,scene$jscomp$0),materials.refreshMaterialUniforms(vertexAlphas,material,_pixelRatio,_height,_transmissionRenderTarget),_WebGLUniforms.WebGLUniforms.upload(_gl,JSCompiler_inline_result.uniformsList,vertexAlphas,textures));material.isShaderMaterial&&
!0===material.uniformsNeedUpdate&&(_WebGLUniforms.WebGLUniforms.upload(_gl,JSCompiler_inline_result.uniformsList,vertexAlphas,textures),material.uniformsNeedUpdate=!1);material.isSpriteMaterial&&scene.setValue(_gl,"center",object.center);scene.setValue(_gl,"modelViewMatrix",object.modelViewMatrix);scene.setValue(_gl,"normalMatrix",object.normalMatrix);scene.setValue(_gl,"modelMatrix",object.matrixWorld);if(material.isShaderMaterial||material.isRawShaderMaterial){scene$jscomp$0=material.uniformsGroups;
for(let i=0,l=scene$jscomp$0.length;i<l;i++)capabilities.isWebGL2?(camera=scene$jscomp$0[i],uniformsGroups.update(camera,encoding),uniformsGroups.bind(camera,encoding)):console.warn("THREE.WebGLRenderer: Uniform Buffer Objects can only be used with WebGL 2.")}JSCompiler_inline_result=encoding;state.setMaterial(material,frontFaceCW);scene$jscomp$0=geometry.index;camera=geometry.attributes.position;if(null===scene$jscomp$0){if(void 0===camera||0===camera.count)return}else if(0===scene$jscomp$0.count)return;
environment=1;!0===material.wireframe&&(scene$jscomp$0=geometries.getWireframeAttribute(geometry),environment=2);bindingStates.setup(object,material,JSCompiler_inline_result,geometry,scene$jscomp$0);frontFaceCW=bufferRenderer;null!==scene$jscomp$0&&(JSCompiler_inline_result=attributes.get(scene$jscomp$0),frontFaceCW=indexedBufferRenderer,frontFaceCW.setIndex(JSCompiler_inline_result));scene=geometry.drawRange.start*environment;encoding=null!==group?group.start*environment:0;JSCompiler_inline_result=
Math.max(scene,encoding);group=Math.max(0,Math.min(null!==scene$jscomp$0?scene$jscomp$0.count:camera.count,scene+geometry.drawRange.count*environment,encoding+(null!==group?group.count*environment:Infinity))-1-JSCompiler_inline_result+1);0!==group&&(object.isMesh?!0===material.wireframe?(state.setLineWidth(material.wireframeLinewidth*(null===_currentRenderTarget?_pixelRatio:1)),frontFaceCW.setMode(_gl.LINES)):frontFaceCW.setMode(_gl.TRIANGLES):object.isLine?(material=material.linewidth,void 0===material&&
(material=1),state.setLineWidth(material*(null===_currentRenderTarget?_pixelRatio:1)),object.isLineSegments?frontFaceCW.setMode(_gl.LINES):object.isLineLoop?frontFaceCW.setMode(_gl.LINE_LOOP):frontFaceCW.setMode(_gl.LINE_STRIP)):object.isPoints?frontFaceCW.setMode(_gl.POINTS):object.isSprite&&frontFaceCW.setMode(_gl.TRIANGLES),object.isInstancedMesh?frontFaceCW.renderInstances(JSCompiler_inline_result,group,object.count):geometry.isInstancedBufferGeometry?frontFaceCW.renderInstances(JSCompiler_inline_result,
group,Math.min(geometry.instanceCount,geometry._maxInstanceCount)):frontFaceCW.render(JSCompiler_inline_result,group))};this.compile=function(scene$jscomp$0,camera){function prepare(material,scene,object){!0===material.transparent&&material.side===_constants.DoubleSide?(material.side=_constants.BackSide,material.needsUpdate=!0,getProgram(material,scene,object),material.side=_constants.FrontSide,material.needsUpdate=!0,getProgram(material,scene,object),material.side=_constants.DoubleSide):getProgram(material,
scene,object)}currentRenderState=renderStates.get(scene$jscomp$0);currentRenderState.init();renderStateStack.push(currentRenderState);scene$jscomp$0.traverseVisible(function(object){object.isLight&&object.layers.test(camera.layers)&&(currentRenderState.pushLight(object),object.castShadow&&currentRenderState.pushShadow(object))});currentRenderState.setupLights(_this.physicallyCorrectLights);scene$jscomp$0.traverse(function(object){const material=object.material;if(material)if(Array.isArray(material))for(let i=
0;i<material.length;i++)prepare(material[i],scene$jscomp$0,object);else prepare(material,scene$jscomp$0,object)});renderStateStack.pop();currentRenderState=null};let onAnimationFrameCallback=null;const animation=new _WebGLAnimation.WebGLAnimation;animation.setAnimationLoop(function(time){onAnimationFrameCallback&&onAnimationFrameCallback(time)});"undefined"!==typeof self&&animation.setContext(self);this.setAnimationLoop=function(callback){onAnimationFrameCallback=callback;xr.setAnimationLoop(callback);
null===callback?animation.stop():animation.start()};xr.addEventListener("sessionstart",onXRSessionStart);xr.addEventListener("sessionend",onXRSessionEnd);this.render=function(scene,camera){if(void 0!==camera&&!0!==camera.isCamera)console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");else if(!0!==_isContextLost){!0===scene.matrixWorldAutoUpdate&&scene.updateMatrixWorld();null===camera.parent&&!0===camera.matrixWorldAutoUpdate&&camera.updateMatrixWorld();!0===xr.enabled&&
!0===xr.isPresenting&&(!0===xr.cameraAutoUpdate&&xr.updateCamera(camera),camera=xr.getCamera());if(!0===scene.isScene)scene.onBeforeRender(_this,scene,camera,_currentRenderTarget);currentRenderState=renderStates.get(scene,renderStateStack.length);currentRenderState.init();renderStateStack.push(currentRenderState);_projScreenMatrix.multiplyMatrices(camera.projectionMatrix,camera.matrixWorldInverse);_frustum.setFromProjectionMatrix(_projScreenMatrix);_localClippingEnabled=this.localClippingEnabled;
_clippingEnabled=clipping.init(this.clippingPlanes,_localClippingEnabled,camera);currentRenderList$jscomp$0=renderLists.get(scene,renderListStack.length);currentRenderList$jscomp$0.init();renderListStack.push(currentRenderList$jscomp$0);projectObject(scene,camera,0,_this.sortObjects);currentRenderList$jscomp$0.finish();!0===_this.sortObjects&&currentRenderList$jscomp$0.sort(_opaqueSort,_transparentSort);!0===_clippingEnabled&&clipping.beginShadows();shadowMap.render(currentRenderState.state.shadowsArray,
scene,camera);!0===_clippingEnabled&&clipping.endShadows();!0===this.info.autoReset&&this.info.reset();background.render(currentRenderList$jscomp$0,scene);currentRenderState.setupLights(_this.physicallyCorrectLights);if(camera.isArrayCamera){const cameras=camera.cameras;for(let i=0,l=cameras.length;i<l;i++){const camera2=cameras[i];renderScene(currentRenderList$jscomp$0,scene,camera2,camera2.viewport)}}else renderScene(currentRenderList$jscomp$0,scene,camera);null!==_currentRenderTarget&&(textures.updateMultisampleRenderTarget(_currentRenderTarget),
textures.updateRenderTargetMipmap(_currentRenderTarget));if(!0===scene.isScene)scene.onAfterRender(_this,scene,camera);bindingStates.resetDefaultState();_currentMaterialId=-1;_currentCamera=null;renderStateStack.pop();currentRenderState=0<renderStateStack.length?renderStateStack[renderStateStack.length-1]:null;renderListStack.pop();currentRenderList$jscomp$0=0<renderListStack.length?renderListStack[renderListStack.length-1]:null}};this.getActiveCubeFace=function(){return _currentActiveCubeFace};this.getActiveMipmapLevel=
...
var _constants=require("module$node_modules$three$src$constants"),_MathUtils=require("module$node_modules$three$src$math$MathUtils"),_Frustum=require("module$node_modules$three$src$math$Frustum"),_Matrix=require("module$node_modules$three$src$math$Matrix4"),_Vector=require("module$node_modules$three$src$math$Vector2"),_Vector2=require("module$node_modules$three$src$math$Vector3"),_Vector3=require("module$node_modules$three$src$math$Vector4"),_WebGLAnimation=require("module$node_modules$three$src$renderers$webgl$WebGLAnimation"),
_WebGLAttributes=require("module$node_modules$three$src$renderers$webgl$WebGLAttributes"),_WebGLBackground=require("module$node_modules$three$src$renderers$webgl$WebGLBackground"),_WebGLBindingStates=require("module$node_modules$three$src$renderers$webgl$WebGLBindingStates"),_WebGLBufferRenderer=require("module$node_modules$three$src$renderers$webgl$WebGLBufferRenderer"),_WebGLCapabilities=require("module$node_modules$three$src$renderers$webgl$WebGLCapabilities"),_WebGLClipping=require("module$node_modules$three$src$renderers$webgl$WebGLClipping"),
_WebGLCubeMaps=require("module$node_modules$three$src$renderers$webgl$WebGLCubeMaps"),_WebGLCubeUVMaps=require("module$node_modules$three$src$renderers$webgl$WebGLCubeUVMaps"),_WebGLExtensions=require("module$node_modules$three$src$renderers$webgl$WebGLExtensions"),_WebGLGeometries=require("module$node_modules$three$src$renderers$webgl$WebGLGeometries"),_WebGLIndexedBufferRenderer=require("module$node_modules$three$src$renderers$webgl$WebGLIndexedBufferRenderer"),_WebGLInfo=require("module$node_modules$three$src$renderers$webgl$WebGLInfo"),
_WebGLMorphtargets=require("module$node_modules$three$src$renderers$webgl$WebGLMorphtargets"),_WebGLObjects=require("module$node_modules$three$src$renderers$webgl$WebGLObjects"),_WebGLPrograms=require("module$node_modules$three$src$renderers$webgl$WebGLPrograms"),_WebGLProperties=require("module$node_modules$three$src$renderers$webgl$WebGLProperties"),_WebGLRenderLists=require("module$node_modules$three$src$renderers$webgl$WebGLRenderLists"),_WebGLRenderStates=require("module$node_modules$three$src$renderers$webgl$WebGLRenderStates"),
_WebGLRenderTarget=require("module$node_modules$three$src$renderers$WebGLRenderTarget"),_WebGLShadowMap=require("module$node_modules$three$src$renderers$webgl$WebGLShadowMap"),_WebGLState=require("module$node_modules$three$src$renderers$webgl$WebGLState"),_WebGLTextures=require("module$node_modules$three$src$renderers$webgl$WebGLTextures"),_WebGLUniforms=require("module$node_modules$three$src$renderers$webgl$WebGLUniforms"),_WebGLUtils=require("module$node_modules$three$src$renderers$webgl$WebGLUtils"),
_WebXRManager=require("module$node_modules$three$src$renderers$webxr$WebXRManager"),_WebGLMaterials=require("module$node_modules$three$src$renderers$webgl$WebGLMaterials"),_WebGLUniformsGroups=require("module$node_modules$three$src$renderers$webgl$WebGLUniformsGroups"),_utils=require("module$node_modules$three$src$utils")}
