...
return nextjournal.viewer.html(cljs.core.into.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.flex.flex-col.items-center.viewer-notebook","div.flex.flex-col.items-center.viewer-notebook",2117798621)], null),cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p1__81404_SHARP_){
return nextjournal.viewer.html((function (){var map__81405 = nextjournal.viewer.meta(p1__81404_SHARP_);
var map__81405__$1 = cljs.core.__destructure_map(map__81405);
var ks = map__81405__$1;
var viewer = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__81405__$1,new cljs.core.Keyword("nextjournal","viewer","nextjournal/viewer",646341759));
var width = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__81405__$1,new cljs.core.Keyword("nextjournal","width","nextjournal/width",-2082667537));
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, ["viewer",(((viewer instanceof cljs.core.Keyword))?["viewer-",cljs.core.name(viewer)].join(''):null),((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(viewer,new cljs.core.Keyword(null,"code","code",1586293142)))?"not-prose":null),(function (){var G__81406 = (function (){var or__4253__auto__ = width;
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
} else {
var G__81407 = viewer;
var G__81407__$1 = (((G__81407 instanceof cljs.core.Keyword))?G__81407.fqn:null);
switch (G__81407__$1) {
case "code":
...
var G__81406__$1 = (((G__81406 instanceof cljs.core.Keyword))?G__81406.fqn:null);
switch (G__81406__$1) {
case "wide":
...
})()], null)], null),(function (){var G__81408 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [nextjournal.viewer.inspect,p1__81404_SHARP_], null);
if(cljs.core.truth_(new cljs.core.Keyword("blob","id","blob/id",-1385637193).cljs$core$IFn$_invoke$arity$1(p1__81404_SHARP_))){
return cljs.core.vary_meta.cljs$core$IFn$_invoke$arity$4(G__81408,cljs.core.assoc,new cljs.core.Keyword(null,"key","key",-1516042587),new cljs.core.Keyword("blob","id","blob/id",-1385637193).cljs$core$IFn$_invoke$arity$1(p1__81404_SHARP_));
} else {
return G__81408;
}
})()], null);
...
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("&",cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.partial.cljs$core$IFn$_invoke$arity$2(clojure.string.join,"="),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__81409_SHARP_){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(p1__81409_SHARP_,(0),cljs.core.name);
}),opts)));
});
nextjournal.viewer.notebook.describe = (function nextjournal$viewer$notebook$describe(result){
var G__81410 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword("nextjournal","type-key","nextjournal/type-key",431230466),nextjournal.viewer.value_type(result),new cljs.core.Keyword("blob","id","blob/id",-1385637193),new cljs.core.Keyword("blob","id","blob/id",-1385637193).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(result))], null);
if(cljs.core.counted_QMARK_(result)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__81410,new cljs.core.Keyword(null,"count","count",2139924085),cljs.core.count(result));
} else {
return G__81410;
}
});
nextjournal.viewer.notebook.paginate = (function nextjournal$viewer$notebook$paginate(result,p__81411){
var map__81412 = p__81411;
var map__81412__$1 = cljs.core.__destructure_map(map__81412);
var opts = map__81412__$1;
var start = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__81412__$1,new cljs.core.Keyword(null,"start","start",-355208981),(0));
var n = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__81412__$1,new cljs.core.Keyword(null,"n","n",562130025));
...
re_frame.context.reg_sub.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword("nextjournal.viewer.notebook","blobs","nextjournal.viewer.notebook/blobs",2028603229),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(function (db,p__81415){
var vec__81417 = p__81415;
var blob_key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__81417,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__81417,(1),null);
var v = vec__81417;
...
nextjournal.viewer.notebook.fetch_BANG_ = (function nextjournal$viewer$notebook$fetch_BANG_(_BANG_result,p__81424,opts){
var map__81425 = p__81424;
var map__81425__$1 = cljs.core.__destructure_map(map__81425);
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__81425__$1,new cljs.core.Keyword("blob","id","blob/id",-1385637193));
...
return fetch(["_blob/",cljs.core.str.cljs$core$IFn$_invoke$arity$1(id),((cljs.core.seq(opts))?["?",nextjournal.viewer.notebook.opts__GT_query(opts)].join(''):null)].join('')).then((function (p1__81421_SHARP_){
return p1__81421_SHARP_.text();
})).then((function (p1__81422_SHARP_){
return cljs.core.reset_BANG_(_BANG_result,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"value","value",305978217),nextjournal.viewer.notebook.read_string(p1__81422_SHARP_)], null));
})).catch((function (p1__81423_SHARP_){
return cljs.core.reset_BANG_(_BANG_result,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"error","error",-978969032),p1__81423_SHARP_], null));
}));
});
nextjournal.viewer.notebook.in_process_fetch_BANG_ = (function nextjournal$viewer$notebook$in_process_fetch_BANG_(_BANG_result,p__81430,opts){
var map__81431 = p__81430;
var map__81431__$1 = cljs.core.__destructure_map(map__81431);
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__81431__$1,new cljs.core.Keyword("blob","id","blob/id",-1385637193));
...
var G__81432 = cljs.core.deref(re_frame.context.subscribe.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("nextjournal.viewer.notebook","blobs","nextjournal.viewer.notebook/blobs",2028603229),id], null)], 0)));
return (resolve.cljs$core$IFn$_invoke$arity$1 ? resolve.cljs$core$IFn$_invoke$arity$1(G__81432) : resolve.call(null,G__81432));
}))).then((function (p1__81427_SHARP_){
return nextjournal.viewer.notebook.paginate(p1__81427_SHARP_,opts);
})).then((function (p1__81428_SHARP_){
return cljs.core.reset_BANG_(_BANG_result,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"value","value",305978217),(function (){var G__81433 = p1__81428_SHARP_;
lambdaisland.glogi.log.cljs$core$IFn$_invoke$arity$4("nextjournal.viewer.notebook",new cljs.core.Keyword(null,"info","info",-317069002),cljs.core.identity(cljs.core.PersistentArrayMap.createAsIfByAssoc([G__81433,new cljs.core.Keyword("in-process-fetch!","value","in-process-fetch!/value",2033041116),new cljs.core.Keyword(null,"line","line",212345235),null])),null);

return G__81433;
})()], null));
})).catch((function (p1__81429_SHARP_){
return cljs.core.reset_BANG_(_BANG_result,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"error","error",-978969032),p1__81429_SHARP_], null));
}));
});
nextjournal.viewer.notebook.get_fetch_opts = (function nextjournal$viewer$notebook$get_fetch_opts(p__81437){
var map__81438 = p__81437;
var map__81438__$1 = cljs.core.__destructure_map(map__81438);
var type_key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__81438__$1,new cljs.core.Keyword("nextjournal","type-key","nextjournal/type-key",431230466));
var count = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__81438__$1,new cljs.core.Keyword(null,"count","count",2139924085));
if(((typeof count === 'number') && ((((count > (0))) && (((cljs.core.contains_QMARK_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"vector","vector",1902966158),null,new cljs.core.Keyword(null,"list","list",765357683),null], null), null),type_key)) && (cljs.core.not((function (){var fexpr__81439 = cljs.core.deref(nextjournal.viewer._BANG_viewers);
return (fexpr__81439.cljs$core$IFn$_invoke$arity$1 ? fexpr__81439.cljs$core$IFn$_invoke$arity$1(type_key) : fexpr__81439.call(null,type_key));
})())))))))){
...
var with_let81440 = reagent.ratom.with_let_values(new cljs.core.Keyword(null,"with-let81440","with-let81440",1128939021));
var temp__5757__auto___81531 = reagent.ratom._STAR_ratom_context_STAR_;
if((temp__5757__auto___81531 == null)){
} else {
var c__74539__auto___81532 = temp__5757__auto___81531;
if((with_let81440.generation === c__74539__auto___81532.ratomGeneration)){
...
(with_let81440.generation = c__74539__auto___81532.ratomGeneration);
}

var init81441 = (with_let81440.length === (0));
var _BANG_result = ((((init81441) || (cljs.core.not(with_let81440.hasOwnProperty((0))))))?(with_let81440[(0)] = reagent.core.atom.cljs$core$IFn$_invoke$arity$1(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"loading?","loading?",1905707049),true], null))):(with_let81440[(0)]));
var fetch_BANG_ = ((((init81441) || (cljs.core.not(with_let81440.hasOwnProperty((1))))))?(with_let81440[(1)] = cljs.core.partial.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword("blob","fetch!","blob/fetch!",1943466498).cljs$core$IFn$_invoke$arity$2(blob,nextjournal.viewer.notebook.fetch_BANG_),_BANG_result,blob)):(with_let81440[(1)]));
var _ = ((((init81441) || (cljs.core.not(with_let81440.hasOwnProperty((2))))))?(with_let81440[(2)] = (function (){var G__81449 = nextjournal.viewer.notebook.get_fetch_opts(blob);
return (fetch_BANG_.cljs$core$IFn$_invoke$arity$1 ? fetch_BANG_.cljs$core$IFn$_invoke$arity$1(G__81449) : fetch_BANG_.call(null,G__81449));
})()):(with_let81440[(2)]));
var res81442 = (function (){var map__81450 = cljs.core.deref(_BANG_result);
var map__81450__$1 = cljs.core.__destructure_map(map__81450);
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__81450__$1,new cljs.core.Keyword(null,"value","value",305978217));
var error = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__81450__$1,new cljs.core.Keyword(null,"error","error",-978969032));
var loading_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__81450__$1,new cljs.core.Keyword(null,"loading?","loading?",1905707049));
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632)], null),cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p__81490){
var vec__81492 = p__81490;
var blob_id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__81492,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__81492,(1),null);
