...
return nextjournal.viewer.html(cljs.core.into.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.flex.flex-col.items-center.viewer-notebook","div.flex.flex-col.items-center.viewer-notebook",2117798621)], null),cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p1__95193_SHARP_){
return nextjournal.viewer.html((function (){var map__95196 = nextjournal.viewer.meta(p1__95193_SHARP_);
var map__95196__$1 = cljs.core.__destructure_map(map__95196);
var ks = map__95196__$1;
var viewer = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__95196__$1,new cljs.core.Keyword("nextjournal","viewer","nextjournal/viewer",646341759));
var width = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__95196__$1,new cljs.core.Keyword("nextjournal","width","nextjournal/width",-2082667537));
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, ["viewer",(((viewer instanceof cljs.core.Keyword))?["viewer-",cljs.core.name(viewer)].join(''):null),((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(viewer,new cljs.core.Keyword(null,"code","code",1586293142)))?"not-prose":null),(function (){var G__95197 = (function (){var or__4253__auto__ = width;
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
} else {
var G__95198 = viewer;
var G__95198__$1 = (((G__95198 instanceof cljs.core.Keyword))?G__95198.fqn:null);
switch (G__95198__$1) {
case "code":
...
var G__95197__$1 = (((G__95197 instanceof cljs.core.Keyword))?G__95197.fqn:null);
switch (G__95197__$1) {
case "wide":
...
})()], null)], null),(function (){var G__95199 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [nextjournal.viewer.inspect,p1__95193_SHARP_], null);
if(cljs.core.truth_(new cljs.core.Keyword("blob","id","blob/id",-1385637193).cljs$core$IFn$_invoke$arity$1(p1__95193_SHARP_))){
return cljs.core.vary_meta.cljs$core$IFn$_invoke$arity$4(G__95199,cljs.core.assoc,new cljs.core.Keyword(null,"key","key",-1516042587),new cljs.core.Keyword("blob","id","blob/id",-1385637193).cljs$core$IFn$_invoke$arity$1(p1__95193_SHARP_));
} else {
return G__95199;
}
})()], null);
...
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("&",cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.partial.cljs$core$IFn$_invoke$arity$2(clojure.string.join,"="),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__95202_SHARP_){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(p1__95202_SHARP_,(0),cljs.core.name);
}),opts)));
});
nextjournal.viewer.notebook.describe = (function nextjournal$viewer$notebook$describe(result){
var G__95206 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword("nextjournal","type-key","nextjournal/type-key",431230466),nextjournal.viewer.value_type(result),new cljs.core.Keyword("blob","id","blob/id",-1385637193),new cljs.core.Keyword("blob","id","blob/id",-1385637193).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(result))], null);
if(cljs.core.counted_QMARK_(result)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__95206,new cljs.core.Keyword(null,"count","count",2139924085),cljs.core.count(result));
} else {
return G__95206;
}
});
nextjournal.viewer.notebook.paginate = (function nextjournal$viewer$notebook$paginate(result,p__95207){
var map__95208 = p__95207;
var map__95208__$1 = cljs.core.__destructure_map(map__95208);
var opts = map__95208__$1;
var start = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__95208__$1,new cljs.core.Keyword(null,"start","start",-355208981),(0));
var n = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__95208__$1,new cljs.core.Keyword(null,"n","n",562130025));
...
re_frame.context.reg_sub.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword("nextjournal.viewer.notebook","blobs","nextjournal.viewer.notebook/blobs",2028603229),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(function (db,p__95210){
var vec__95211 = p__95210;
var blob_key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__95211,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__95211,(1),null);
var v = vec__95211;
...
nextjournal.viewer.notebook.fetch_BANG_ = (function nextjournal$viewer$notebook$fetch_BANG_(_BANG_result,p__95217,opts){
var map__95218 = p__95217;
var map__95218__$1 = cljs.core.__destructure_map(map__95218);
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__95218__$1,new cljs.core.Keyword("blob","id","blob/id",-1385637193));
...
return fetch(["_blob/",cljs.core.str.cljs$core$IFn$_invoke$arity$1(id),((cljs.core.seq(opts))?["?",nextjournal.viewer.notebook.opts__GT_query(opts)].join(''):null)].join('')).then((function (p1__95214_SHARP_){
return p1__95214_SHARP_.text();
})).then((function (p1__95215_SHARP_){
return cljs.core.reset_BANG_(_BANG_result,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"value","value",305978217),nextjournal.viewer.notebook.read_string(p1__95215_SHARP_)], null));
})).catch((function (p1__95216_SHARP_){
return cljs.core.reset_BANG_(_BANG_result,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"error","error",-978969032),p1__95216_SHARP_], null));
}));
});
nextjournal.viewer.notebook.in_process_fetch_BANG_ = (function nextjournal$viewer$notebook$in_process_fetch_BANG_(_BANG_result,p__95225,opts){
var map__95226 = p__95225;
var map__95226__$1 = cljs.core.__destructure_map(map__95226);
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__95226__$1,new cljs.core.Keyword("blob","id","blob/id",-1385637193));
...
var G__95227 = cljs.core.deref(re_frame.context.subscribe.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("nextjournal.viewer.notebook","blobs","nextjournal.viewer.notebook/blobs",2028603229),id], null)], 0)));
return (resolve.cljs$core$IFn$_invoke$arity$1 ? resolve.cljs$core$IFn$_invoke$arity$1(G__95227) : resolve.call(null,G__95227));
}))).then((function (p1__95221_SHARP_){
return nextjournal.viewer.notebook.paginate(p1__95221_SHARP_,opts);
})).then((function (p1__95222_SHARP_){
return cljs.core.reset_BANG_(_BANG_result,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"value","value",305978217),(function (){var G__95228 = p1__95222_SHARP_;
lambdaisland.glogi.log.cljs$core$IFn$_invoke$arity$4("nextjournal.viewer.notebook",new cljs.core.Keyword(null,"info","info",-317069002),cljs.core.identity(cljs.core.PersistentArrayMap.createAsIfByAssoc([G__95228,new cljs.core.Keyword("in-process-fetch!","value","in-process-fetch!/value",2033041116),new cljs.core.Keyword(null,"line","line",212345235),null])),null);

return G__95228;
})()], null));
})).catch((function (p1__95223_SHARP_){
return cljs.core.reset_BANG_(_BANG_result,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"error","error",-978969032),p1__95223_SHARP_], null));
}));
});
nextjournal.viewer.notebook.get_fetch_opts = (function nextjournal$viewer$notebook$get_fetch_opts(p__95229){
var map__95230 = p__95229;
var map__95230__$1 = cljs.core.__destructure_map(map__95230);
var type_key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__95230__$1,new cljs.core.Keyword("nextjournal","type-key","nextjournal/type-key",431230466));
var count = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__95230__$1,new cljs.core.Keyword(null,"count","count",2139924085));
if(((typeof count === 'number') && ((((count > (0))) && (((cljs.core.contains_QMARK_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"vector","vector",1902966158),null,new cljs.core.Keyword(null,"list","list",765357683),null], null), null),type_key)) && (cljs.core.not((function (){var fexpr__95235 = cljs.core.deref(nextjournal.viewer._BANG_viewers);
return (fexpr__95235.cljs$core$IFn$_invoke$arity$1 ? fexpr__95235.cljs$core$IFn$_invoke$arity$1(type_key) : fexpr__95235.call(null,type_key));
})())))))))){
...
var with_let95237 = reagent.ratom.with_let_values(new cljs.core.Keyword(null,"with-let95237","with-let95237",844145535));
var temp__5757__auto___95294 = reagent.ratom._STAR_ratom_context_STAR_;
if((temp__5757__auto___95294 == null)){
} else {
var c__85826__auto___95295 = temp__5757__auto___95294;
if((with_let95237.generation === c__85826__auto___95295.ratomGeneration)){
...
(with_let95237.generation = c__85826__auto___95295.ratomGeneration);
}

var init95238 = (with_let95237.length === (0));
var _BANG_result = ((((init95238) || (cljs.core.not(with_let95237.hasOwnProperty((0))))))?(with_let95237[(0)] = reagent.core.atom.cljs$core$IFn$_invoke$arity$1(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"loading?","loading?",1905707049),true], null))):(with_let95237[(0)]));
var fetch_BANG_ = ((((init95238) || (cljs.core.not(with_let95237.hasOwnProperty((1))))))?(with_let95237[(1)] = cljs.core.partial.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword("blob","fetch!","blob/fetch!",1943466498).cljs$core$IFn$_invoke$arity$2(blob,nextjournal.viewer.notebook.fetch_BANG_),_BANG_result,blob)):(with_let95237[(1)]));
var _ = ((((init95238) || (cljs.core.not(with_let95237.hasOwnProperty((2))))))?(with_let95237[(2)] = (function (){var G__95251 = nextjournal.viewer.notebook.get_fetch_opts(blob);
return (fetch_BANG_.cljs$core$IFn$_invoke$arity$1 ? fetch_BANG_.cljs$core$IFn$_invoke$arity$1(G__95251) : fetch_BANG_.call(null,G__95251));
})()):(with_let95237[(2)]));
var res95239 = (function (){var map__95252 = cljs.core.deref(_BANG_result);
var map__95252__$1 = cljs.core.__destructure_map(map__95252);
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__95252__$1,new cljs.core.Keyword(null,"value","value",305978217));
var error = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__95252__$1,new cljs.core.Keyword(null,"error","error",-978969032));
var loading_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__95252__$1,new cljs.core.Keyword(null,"loading?","loading?",1905707049));
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632)], null),cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p__95266){
var vec__95267 = p__95266;
var blob_id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__95267,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__95267,(1),null);
