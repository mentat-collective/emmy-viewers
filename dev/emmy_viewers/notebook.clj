...
;; ## Demos
;;
;; - [examples.complex](/dev/examples/complex.clj)
;; - [examples.continued-fractions](/dev/examples/continued_fractions.clj)
;; - [examples.expression](/dev/examples/expression.clj)
;; - [examples.functions](/dev/examples/functions.clj)
;; - [examples.index.md](/dev/examples/index.md)
;; - [examples.mafs](/dev/examples/mafs.clj)
;; - [examples.manifold.pq-knot](/dev/examples/manifold/pq_knot.cljc)
;; - [examples.mathbox.cube-controls](/dev/examples/mathbox/cube_controls.clj)
;; - [examples.matrix](/dev/examples/matrix.clj)
;; - [examples.modint](/dev/examples/modint.clj)
;; - [examples.number](/dev/examples/number.clj)
;; - [examples.operator](/dev/examples/operator.clj)
;; - [examples.polynomial](/dev/examples/polynomial.clj)
;; - [examples.power-series](/dev/examples/power_series.clj)
;; - [examples.quaternion](/dev/examples/quaternion.clj)
;; - [examples.rational-function](/dev/examples/rational_function.clj)
;; - [examples.simulation.cylinder-flow](/dev/examples/simulation/cylinder_flow.cljc)
;; - [examples.simulation.double-ellipsoid](/dev/examples/simulation/double_ellipsoid.clj)
;; - [examples.simulation.ellipsoid](/dev/examples/simulation/ellipsoid.clj)
;; - [examples.simulation.lorenz](/dev/examples/simulation/lorenz.cljc)
;; - [examples.simulation.oscillator](/dev/examples/simulation/oscillator.clj)
;; - [examples.simulation.phase-portrait](/dev/examples/simulation/phase_portrait.cljc)
;; - [examples.simulation.quartic-well](/dev/examples/simulation/quartic_well.cljc)
;; - [examples.simulation.toroid](/dev/examples/simulation/toroid.clj)
;; - [examples.stern-brocot](/dev/examples/stern_brocot.clj)
;; - [examples.structure](/dev/examples/structure.clj)
;; - [examples.symbolic.einstein](/dev/examples/symbolic/einstein.clj)
;; - [examples.vega.pendulum](/dev/examples/vega/pendulum.clj)
